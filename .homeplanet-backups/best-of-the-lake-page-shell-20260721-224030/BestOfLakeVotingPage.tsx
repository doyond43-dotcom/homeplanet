...
export default function BestOfLakeVotingPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f7f6f1] text-[#17212b]">
      ...
      <footer className="border-t-[5px] border-[#176f72] bg-[#17212b]">
        <div className="mx-auto max-w-6xl px-4 py-7 text-center text-sm text-white/70 sm:px-6">
          Best of the Lake voting experience concept · Built by HomePlanet
        </div>
      </footer>
    </main>
  );
