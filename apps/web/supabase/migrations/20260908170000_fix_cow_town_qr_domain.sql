...
-- Keep physical Cow Town QR tags on the permanent HomePlanet public route.
...
begin
  ...
  v_qr_destination :=
    'https://www.homeplanet.city/planet/cow-town-tags/tag/' ||
    v_cow_town_id;
...
-- Repair any tag assignments created with the former Cow Town QR domain.
update public.cow_town_tag_assignments
set qr_destination =
  'https://www.homeplanet.city/planet/cow-town-tags/tag/' || cow_town_id
where qr_destination =
  'https://okeechobeetogether.org/planet/cow-town-tags/tag/' || cow_town_id;
