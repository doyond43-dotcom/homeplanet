...
const marker = "VISIBLE_RESOLVE_PROJECT_CONTROL";
...
const insert = `              <p>
              ...
              {/* VISIBLE_RESOLVE_PROJECT_CONTROL */}
...
if (!text.includes(marker)) {
  if (!text.includes(target)) {
    throw new Error("Exact Project Overview target not found.");
  }
...
console.log("Final visible resolve button inserted.");
