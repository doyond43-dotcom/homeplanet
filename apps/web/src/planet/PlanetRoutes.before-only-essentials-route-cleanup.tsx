...
<Route path="start" element={<StartPage />} />
      ...
      <Route path="only-the-essentials-cleaning" element={<OnlyTheEssentialsPublicLanding />} />
      ...
      <Route path="demo/bella" element={<GuardianBellaPreview />} />
      ...
      <Route path="emily-learning" element={<EmilyLearningDesk />} />
      ...
      <Route path="*" element={<Navigate to="/planet/start" replace />} />
          <Route path="/planet/only-the-essentials-cleaning" element={<OnlyTheEssentialsCustomerLanding />} />
    </Routes>
  );
}
