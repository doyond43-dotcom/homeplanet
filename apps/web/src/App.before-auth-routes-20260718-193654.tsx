    ...
    <BrowserRouter>
      <Suspense fallback={null}>
        <Routes>
          ...
          <Route path="/planet/jones-equipment-rental-repair/board" element={<RequireAuth><JonesEquipmentOperatorBoard /></RequireAuth>} />
          <Route path="/jme/board" element={<RequireAuth><JonesEquipmentOperatorBoard /></RequireAuth>} />
