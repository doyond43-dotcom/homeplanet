...
type InvoiceActionType = "copied" | "texted" | "emailed" | "shared";
...
type AutoRepairInvoicePanelProps = {
  ...
  onInvoiceAction?: (action: InvoiceActionType, invoiceText: string) => void;
};
      ...
      <div className="mt-4 rounded-[22px] border border-white/10 bg-[#070d1a] p-4">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          <button
            type="button"
            onClick={() => {
              onInvoiceAction?.("copied", invoiceText);
          ...
          <button
            type="button"
            onClick={() => {
              onInvoiceAction?.("texted", invoiceText);
              openTextMessage(job.phone, invoiceText);
            }}
          ...
          <button
            type="button"
            onClick={() => {
              onInvoiceAction?.("emailed", invoiceText);
          ...
          <button
            type="button"
            onClick={async () => {
              onInvoiceAction?.("shared", invoiceText);
