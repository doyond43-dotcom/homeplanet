    ...
    <main className="min-h-screen bg-[#f7f6f1] text-[#17212b]">
      ...
      <footer className="border-t-[5px] border-[#176f72] bg-[#17212b] text-white">
        <div className="mx-auto max-w-3xl px-4 py-10 text-center sm:px-6">
          ...
          <div className="mx-auto mt-7 h-px max-w-md bg-white/15" />

          <div className="mt-7 text-xs font-black uppercase tracking-[0.16em] text-[#7fc4c1]">
