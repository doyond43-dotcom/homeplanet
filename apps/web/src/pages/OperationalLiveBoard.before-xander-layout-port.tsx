              ...
              <div style={{ display: "grid", gap: 12 }}>
                ...
                <div
                  style={{
                    ...
                    background:
                      "radial-gradient(circle at top left, rgba(16,185,129,0.24), transparent 34%), linear-gradient(135deg, rgba(255,255,255,0.10), rgba(6,78,59,0.18), rgba(8,47,73,0.14))",
                    boxShadow: "0 0 45px rgba(34,211,238,0.12), inset 0 1px 0 rgba(255,255,255,0.14)",
                    padding: 14,
                    overflow: "hidden",
                  }}
                >
                  ...
                  <div style={{ marginTop: 4, fontSize: 12, lineHeight: 1.45, color: "rgba(255,255,255,0.68)" }}>
                    Add before photos, after photos, payment status, and QR proof from one live job card.
                  </div>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "1fr 34px 1fr", gap: 10, alignItems: "center", marginTop: 14 }}>
                    <button
                      style={{
                        ...
                        padding: 12,
                        cursor: "pointer",
                        boxShadow: selectedJob.beforePhotos.length ? "0 0 28px rgba(16,185,129,0.16)" : "none",
                      }}
                      onClick={() => beforeInputRef.current?.click()}
                    >
                      <div style={{ fontSize: 11, fontWeight: 950, letterSpacing: "0.1em", color: "#a7f3d0" }}>BEFORE</div>
                      <div style={{ marginTop: 14, fontSize: 28 }}>??</div>
                      ...
                      <div style={{ marginTop: 8, fontSize: 11, color: "rgba(255,255,255,0.45)" }}>
                        {selectedJob.beforePhotos.length} uploaded
                      </div>
                    </button>
                    ...
                    <button
                      style={{
                        ...
                        padding: 12,
                        cursor: "pointer",
                        boxShadow: selectedJob.afterPhotos.length ? "0 0 28px rgba(16,185,129,0.16)" : "none",
                      }}
                    ...
                    >
                      ...
                      <div style={{ marginTop: 8, fontSize: 11, color: "rgba(255,255,255,0.45)" }}>
                        {selectedJob.afterPhotos.length} uploaded
                      </div>
                    </button>
                  </div>
