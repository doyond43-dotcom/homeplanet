...
export default function VZProfessionalLawncareLanding() {
  ...
  return (
    <main className="min-h-screen bg-[#090b09] text-white">
      ...
      <section
        id="estimate"
        className="relative scroll-mt-6 overflow-hidden border-b border-white/10 bg-[radial-gradient(circle_at_78%_38%,rgba(8,127,35,0.18),transparent_34%),linear-gradient(180deg,#090b09_0%,#0b100b_100%)]"
      >
        <div className="mx-auto grid max-w-[1380px] gap-12 px-5 py-20 sm:px-8 lg:grid-cols-[0.82fr_1.18fr] lg:px-10 lg:py-24">
          <div>
            ...
            <h2 className="mt-4 max-w-[560px] text-4xl font-black uppercase leading-[0.94] tracking-[-0.045em] sm:text-5xl lg:text-6xl">
              Show Eric what needs attention.
            </h2>

            <p className="mt-6 max-w-[540px] text-base leading-7 text-white/55">
              Choose the service, share the property details, and tell Eric what needs attention.
            </p>

            <div className="mt-9 space-y-4">
              <p className="flex items-center gap-3 text-sm font-bold text-white/70">
                <Check size={17} className="text-[#7CFC00]" />
          ...
          <form
            ...
            className="grid gap-4 rounded-[2rem] border border-[#FFD000]/20 bg-[linear-gradient(145deg,rgba(8,127,35,0.13),rgba(255,255,255,0.025)_42%,rgba(13,13,13,0.92)_100%)] p-5 shadow-2xl shadow-black/40 ring-1 ring-[#7CFC00]/10 sm:grid-cols-2 sm:p-8"
          >
