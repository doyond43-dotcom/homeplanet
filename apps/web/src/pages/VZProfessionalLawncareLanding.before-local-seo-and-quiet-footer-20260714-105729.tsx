...
<footer className="relative border-t border-white/10 bg-[#060706]">
        <div className="absolute inset-x-0 top-0 h-px bg-[linear-gradient(90deg,transparent_0%,#FFD000_28%,#7CFC00_52%,#087F23_76%,transparent_100%)] opacity-60" />

        <div className="mx-auto grid max-w-[1380px] gap-6 px-5 py-8 text-sm text-white/45 sm:px-8 md:grid-cols-[1fr_auto_1fr] md:items-center lg:px-10">
          <div>
          ...
          <p className="text-xs font-bold uppercase tracking-[0.16em] text-white/38 md:text-center">
            Okeechobee, Florida
          </p>
          ...
          <div className="md:text-right">
            <a
              href={`tel:${phone}`}
              className="font-bold text-white transition hover:text-[#FFD000]"
            >
              {formattedPhone}
            </a>
