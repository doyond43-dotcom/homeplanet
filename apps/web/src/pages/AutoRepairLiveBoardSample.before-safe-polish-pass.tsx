...
function resolveLiveBoardConfig(args: {
  ...
  return resolveStarterBoardConfig("auto-repair");
}
...
export default function AutoRepairLiveBoard() {
  ...
  const isExplicitDemoRoute =
    location.pathname === "/planet/demo/auto-service" ||
    location.pathname === "/planet/demo/auto-service-sample";
  const liveBoardSlug =
  ...
  const forcedCampName = slugForcesCamp ? "Taylor Creek Automotive" : "";

  const rawBoardName =
    isForcedCampDemo
      ? "Taylor Creek Automotive"
      : forcedCampName ||
        boardMeta?.business_name?.trim() ||
        scopedPayload.businessName?.trim() ||
        "";

  const businessName = isExplicitDemoRoute ? "Taylor Creek Automotive" : "Live Board";

const boardTitle = makeBoardTitle(businessName);

  const city = isExplicitDemoRoute ? "Okeechobee" : "Your City";
      ...
      {!isRestaurant && !loading && !isClaimed && claimPanelDismissed ? (
        <div className="fixed bottom-5 right-5 z-[65]">
          <button
            ...
            className="rounded-full transition-all duration-200 border border-cyan-400/25 bg-[#081122] px-5 py-3 text-sm font-semibold text-cyan-100 shadow-[0_0_30px_rgba(0,0,0,0.35)] transition-all duration-200 hover:bg-[#0b1730]"
          >
            Start 14-Day Trial
          </button>
        </div>
  ...
  <div className="mb-4 rounded-xl border border-cyan-400/20 bg-[#061226] px-4 py-3 shadow-[0_0_20px_rgba(34,211,238,0.08)]">
    <div className="flex flex-col gap-3 text-xs md:flex-row md:items-center md:justify-between">
      ...
      <div className="text-right text-[11px] uppercase tracking-[0.18em] text-white/40">
          ...
          <>
            <div className="mb-5 overflow-hidden rounded-[30px] border border-cyan-400/20 bg-gradient-to-br from-cyan-500/10 via-slate-900 to-slate-950 shadow-[0_0_80px_rgba(34,211,238,0.12)]">
              <div className="grid gap-4 px-6 py-8 md:grid-cols-[1.2fr_0.8fr] md:px-8">
                <div>
                  ...
                  <div className="mt-6 flex flex-wrap gap-3">
                    <button
                      ...
                      className="rounded-full transition-all duration-200 bg-cyan-400 px-5 py-3 text-sm font-semibold text-slate-950 transition-all duration-200 hover:scale-[1.01]"
                    >
                    ...
                    <button
                      ...
                      className="rounded-full transition-all duration-200 border border-white/[0.09] px-5 py-3 text-sm font-semibold text-white transition-all duration-200 hover:bg-white/5"
                    >
                      Reload Live Data
                    </button>
                    ...
                    <button
                      ...
                      className="rounded-full transition-all duration-200 border border-white/[0.09] bg-white/[0.03] px-5 py-3 text-sm font-semibold text-white transition-all duration-200 hover:bg-white/[0.06]"
                    >
                      Switch to Work Mode
                    </button>
                    ...
                    {isRestaurant ? (
                      <>
                        <div className="rounded-full transition-all duration-200 border border-amber-400/20 bg-amber-400/10 px-4 py-3 text-sm font-semibold text-amber-100">
                          Kitchen mode active
                        </div>
                        ...
                        <button
                          ...
                          className="rounded-full transition-all duration-200 border border-white/[0.09] bg-white/[0.035] px-5 py-3 text-sm font-semibold text-white transition-all duration-200 hover:bg-white/[0.08]"
                        >
                          Manager Panel
                        </button>
                      </>
                ...
                <div className="rounded-[26px] transition-all duration-200 border border-white/[0.09] bg-white/[0.035] p-4">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <div className="rounded-full transition-all duration-200 border border-cyan-400/20 bg-cyan-400/10 px-3 py-1 text-xs font-semibold text-cyan-100">
            ...
            {boardMeta ? (
              <div className="mb-5 rounded-[28px] border border-emerald-400/20 bg-emerald-400/10 p-4">
                <div className="flex flex-wrap items-center justify-between gap-4">
                  ...
                  <div className="rounded-full transition-all duration-200 border border-emerald-300/25 bg-emerald-300/10 px-4 py-2 text-sm font-semibold text-emerald-100">
            ...
            {boardMeta && isClaimed && !isRestaurant ? (
              <div className="mb-5 rounded-[28px] border border-cyan-400/20 bg-cyan-400/10 p-4">
                <div className="flex flex-wrap items-center justify-between gap-4">
                  ...
                  <div className="rounded-full transition-all duration-200 border border-cyan-300/25 bg-cyan-300/10 px-4 py-2 text-sm font-semibold text-cyan-100">
                    Trial running
                  </div>
                </div>
          ...
          <>
            ...
            {(boardMeta || (isClaimed && !isRestaurant)) ? (
              <div className="mb-4 grid gap-3 md:grid-cols-[1.2fr_0.8fr]">
                {boardMeta ? (
                  <div className="rounded-[22px] transition-all duration-200 border border-emerald-400/20 bg-emerald-400/10 px-4 py-4">
                    <div className="flex flex-wrap items-center justify-between gap-3">
                      ...
                      <button
                        type="button"
                        onClick={() => setBoardViewMode("reveal")}
                        className="rounded-full transition-all duration-200 border border-white/[0.09] bg-white/[0.035] px-3 py-2 text-xs font-semibold text-white transition-all duration-200 hover:bg-white/[0.06]"
                      >
                        View full proof
                      </button>
                    </div>
                ...
                {boardMeta && isClaimed && !isRestaurant ? (
                  <div className="rounded-[22px] transition-all duration-200 border border-cyan-400/20 bg-cyan-400/10 px-4 py-4">
        ...
        >
          <div className="rounded-[30px] border border-white/[0.09] bg-[#081122] p-4 md:p-5">
            <div className="mb-4 flex items-center justify-between gap-4">
              ...
              <div className="rounded-full transition-all duration-200 border border-cyan-400/25 bg-cyan-400/10 px-4 py-2 text-sm font-semibold text-cyan-100">
                {config.familyLabel}
              </div>
            </div>
              ...
              {grouped.map((column) => (
                ...
                >
                  <div className="mb-3 flex items-center justify-between gap-3">
                    ...
                    <div className="rounded-full transition-all duration-200 border border-white/[0.09] px-3 py-1 text-xs text-slate-300">
                      {column.jobs.length}
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    {column.jobs.length === 0 ? (
                      <div className="rounded-2xl transition-all duration-200 border border-dashed border-white/[0.09] px-4 py-5 text-sm text-slate-500">
                        {isRestaurant
                          ? "No tickets here yet."
                          : isCamp
                            ...
                            >
                              ...
                              >
                                ...
                                <div className="mt-3 grid gap-2 md:grid-cols-2">
                                  <div className="rounded-2xl transition-all duration-200 border border-white/[0.09] bg-white/[0.03] px-3 py-2">
              ...
              <div className="mt-5 rounded-[24px] border border-white/[0.09] bg-white/[0.03] p-4">
                <div className="flex flex-wrap items-center justify-between gap-3">
                  ...
                  <button
                    type="button"
                    onClick={() => setManagerPanelOpen(true)}
                    className="rounded-full transition-all duration-200 border border-white/[0.09] px-4 py-2 text-sm font-semibold text-slate-300 transition-all duration-200 hover:bg-white/[0.06]"
                  >
                    Open Manager Panel
                  </button>
                </div>
                ...
                <>
                  <div className="mb-5 flex items-start justify-between gap-4">
                    ...
                    <button
                      ...
                      className="rounded-full transition-all duration-200 border border-white/[0.09] px-4 py-2 text-sm font-semibold text-white transition-all duration-200 hover:bg-white/5"
                    >
                      Close
                    </button>
                  </div>
                      ...
                      <div className="rounded-[24px] border border-violet-400/20 bg-violet-400/10 p-4">
                        ...
                        <div className="mt-4 grid gap-3 md:grid-cols-2">
                          <button
                            ...
                            className="rounded-full transition-all duration-200 border border-violet-300/30 bg-violet-300/15 px-4 py-3 text-sm font-semibold text-violet-50 transition-all duration-200 hover:bg-violet-300/20 disabled:cursor-not-allowed disabled:opacity-60"
                          >
                          ...
                          <button
                            ...
                            disabled={proofCaptureRunningJobId !== selectedJob.id}
                            className="rounded-full transition-all duration-200 border border-white/[0.09] bg-white/[0.035] px-4 py-3 text-sm font-semibold text-white transition-all duration-200 hover:bg-white/[0.08] disabled:cursor-not-allowed disabled:opacity-60"
                          >
                            Stop Capture
                          </button>
                        </div>
                        ...
                        <div className="mt-4 flex flex-wrap gap-2">
                          <button
                            ...
                            className="rounded-full transition-all duration-200 border border-amber-400/25 bg-amber-400/10 px-3 py-2 text-xs font-semibold text-amber-100 transition-all duration-200 hover:bg-amber-400/15"
                          >
                            Hidden Issue
                          </button>
                          ...
                          <button
                            ...
                            className="rounded-full transition-all duration-200 border border-red-400/25 bg-red-400/10 px-3 py-2 text-xs font-semibold text-red-100 transition-all duration-200 hover:bg-red-400/15"
                          >
                            Safety
                          </button>
                          ...
                          <button
                            ...
                            className="rounded-full transition-all duration-200 border border-cyan-400/25 bg-cyan-400/10 px-3 py-2 text-xs font-semibold text-cyan-100 transition-all duration-200 hover:bg-cyan-400/15"
                          >
                            In Progress
                          </button>
                          ...
                          <button
                            ...
                            className="rounded-full transition-all duration-200 border border-emerald-400/25 bg-emerald-400/10 px-3 py-2 text-xs font-semibold text-emerald-100 transition-all duration-200 hover:bg-emerald-400/15"
                          >
                            Completed
                          </button>
                        </div>
                        ...
                        <div className="mt-4 rounded-[22px] border border-white/[0.09] bg-[#070d1a] p-3">
                          <div className="flex items-center justify-between gap-3">
                            ...
                            <button
                              ...
                              className="rounded-full transition-all duration-200 border border-white/[0.09] px-3 py-1 text-[11px] font-semibold text-slate-300 transition-all duration-200 hover:bg-white/[0.06] disabled:cursor-not-allowed disabled:opacity-50"
                            >
                              Clear
                            </button>
                          </div>
                          ...
                          <div className="mt-3 space-y-2">
                            {selectedJob.proof?.length ? (
                              selectedJob.proof.map((clip) => (
                                <div
                                  key={clip.id}
                                  className="rounded-2xl transition-all duration-200 border border-white/[0.09] bg-white/[0.03] px-3 py-3"
                                >
                                  <div className="flex items-start justify-between gap-3">
                                    <div>
                                    ...
                                    <div className="rounded-full transition-all duration-200 border border-violet-400/20 bg-violet-400/10 px-2.5 py-1 text-[10px] font-semibold text-violet-100">
                                      Proof
                                    </div>
                                  </div>
                    ...
                    {!isCamp ? (
                      <div className="rounded-[24px] border border-emerald-400/20 bg-emerald-400/10 p-4">
                        <div className="flex flex-wrap items-start justify-between gap-3">
                          ...
                          {copiedMessage ? (
                            <div className="rounded-full transition-all duration-200 border border-emerald-400/20 px-3 py-1 text-xs text-emerald-100">
                              {copiedMessage}
                            </div>
                          ) : null}
                        </div>
                        ...
                        <div className="mt-4 grid gap-4 md:grid-cols-2">
                          <div className="rounded-[22px] transition-all duration-200 border border-white/[0.09] bg-[#070d1a] p-4">
                            <div className="flex items-center justify-between gap-3">
                              <div>
                                <div className="text-sm font-semibold text-white">
                                  Cash App
                              ...
                              <div className="rounded-full transition-all duration-200 border border-emerald-400/25 bg-emerald-400/10 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.18em] text-emerald-100">
                                Scan or tap
                              </div>
                            </div>
                            ...
                            <div className="mt-4 grid gap-2">
                              <button
                                ...
                                disabled={!cashAppUrl}
                                className="rounded-full transition-all duration-200 bg-emerald-300 px-4 py-3 text-sm font-semibold text-slate-950 transition-all duration-200 hover:scale-[1.01] disabled:cursor-not-allowed disabled:opacity-50"
                              >
                                Open Cash App
                              </button>
                              ...
                              <button
                                ...
                                disabled={!cashAppUrl}
                                className="rounded-full transition-all duration-200 border border-white/[0.09] bg-white/[0.035] px-4 py-3 text-sm font-semibold text-white transition-all duration-200 hover:bg-white/[0.08] disabled:cursor-not-allowed disabled:opacity-50"
                              >
                                Copy Cash App Link
                              </button>
                            </div>
                          ...
                          <div className="rounded-[22px] transition-all duration-200 border border-white/[0.09] bg-[#070d1a] p-4">
                            <div className="flex items-center justify-between gap-3">
                              ...
                              <div className="rounded-full transition-all duration-200 border border-cyan-400/25 bg-cyan-400/10 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.18em] text-cyan-100">
                                Copy fast
                              </div>
                            </div>
                            ...
                            <div className="mt-4 grid gap-2">
                              <button
                                ...
                                className="rounded-full transition-all duration-200 bg-cyan-400 px-4 py-3 text-sm font-semibold text-slate-950 transition-all duration-200 hover:scale-[1.01] disabled:cursor-not-allowed disabled:opacity-50"
                              >
                                Copy Zelle
                              </button>
                    ...
                    {!isCamp ? (
                      <div className="rounded-[24px] border border-emerald-400/20 bg-emerald-400/10 p-4">
                        <div className="flex items-center justify-between gap-3">
                          ...
                          <div className="rounded-full transition-all duration-200 border border-emerald-300/25 bg-emerald-300/10 px-3 py-1 text-xs font-semibold text-emerald-100">
                        ...
                        <div className="mt-4 space-y-3">
                          {jobReceipts.length ? (
                            jobReceipts.map((receipt) => (
                              <div
                                key={receipt.id}
                                className="rounded-2xl transition-all duration-200 border border-white/[0.09] bg-black/10 px-4 py-3"
                              >
                                <div className="flex flex-wrap items-center justify-between gap-3">
                                  <div className="text-sm font-semibold text-white">
                                    {receipt.vendorName}
                                  ...
                                  <div className="rounded-full transition-all duration-200 border border-white/[0.09] bg-white/[0.035] px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.18em] text-slate-200">
...
� HomePlanet Proof`;
                                    ...
                                    className="rounded-full transition-all duration-200 border border-white/[0.09] px-3 py-1 text-xs text-white transition-all duration-200 hover:bg-white/10"
                                  >
                                    Copy Proof
                                  </button>
                                </div>
                            ...
                            <div className="rounded-2xl transition-all duration-200 border border-dashed border-white/[0.09] px-4 py-5 text-sm text-slate-400">
                    ...
                    <div className="rounded-[24px] border border-cyan-400/20 bg-cyan-400/10 p-4">
                      <div className="flex items-center justify-between gap-3">
                        ...
                        {copiedMessage ? (
                          <div className="rounded-full transition-all duration-200 border border-cyan-400/20 px-3 py-1 text-xs text-cyan-100">
                            {copiedMessage}
                          </div>
                        ) : null}
                      </div>
              ...
              <div className="flex flex-wrap gap-3">
                {ticketEditorDraft.id ? (
                  <button
                    ...
                    className="rounded-full transition-all duration-200 border border-red-400/25 bg-red-400/10 px-5 py-3 text-sm font-semibold text-red-200 transition-all duration-200 hover:bg-red-400/15 disabled:cursor-not-allowed disabled:opacity-60"
                  >
                    Delete Ticket
                  </button>
                ) : null}
                ...
                <button
                  ...
                  onClick={closeRestaurantTicketEditor}
                  disabled={ticketEditorSaving}
                  className="rounded-full transition-all duration-200 border border-white/[0.09] px-5 py-3 text-sm font-semibold text-white transition-all duration-200 hover:bg-white/5 disabled:cursor-not-allowed disabled:opacity-60"
                >
                  Cancel
                </button>
                ...
                <button
                  ...
                  disabled={ticketEditorSaving}
                  className="rounded-full transition-all duration-200 bg-cyan-400 px-5 py-3 text-sm font-semibold text-slate-950 transition-all duration-200 hover:scale-[1.01] disabled:cursor-not-allowed disabled:opacity-60"
                >
                  {ticketEditorSaving
                    ? "Saving..."
                    : ticketEditorDraft.id
...
function MessageActionCard({
  ...
  return (
    <div className="rounded-2xl transition-all duration-200 border border-white/[0.09] bg-white/[0.05] px-4 py-4">
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        ...
        <button
          ...
          className="rounded-full transition-all duration-200 border border-white/[0.09] px-4 py-2 text-sm font-semibold text-white transition-all duration-200 hover:bg-white/[0.06]"
        >
          Copy message
        </button>
      </div>
...
function ProofCard({
  ...
  return (
    <div className="rounded-[22px] transition-all duration-200 border border-white/[0.09] bg-white/[0.035] p-4">
      <div className="text-xs uppercase tracking-[0.22em] text-slate-500">
        {label}
      </div>
...
function MiniStat({
  ...
  return (
    <div className="rounded-2xl transition-all duration-200 border border-white/[0.09] bg-white/[0.035] p-3">
      <div className="text-[11px] uppercase tracking-[0.18em] text-slate-500">
        {label}
      </div>
...
function NotificationLine({
  ...
  return (
    <div className="rounded-2xl transition-all duration-200 border border-amber-300/15 bg-black/10 px-4 py-3">
