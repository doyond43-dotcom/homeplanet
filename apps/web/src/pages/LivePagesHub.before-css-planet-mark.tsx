...
export default function LivePagesHub() {
  ...
  const mark: CSSProperties = {
    ...
    borderRadius: 999,
    objectFit: "contain",
    filter: "drop-shadow(0 0 18px rgba(59,130,246,0.45)) drop-shadow(0 0 16px rgba(52,211,153,0.22))",
  };
      ...
      <div style={wrap}>
        <nav style={nav}>
          <Link to="/planet/live-pages" style={brand}>
            <img src="/images/HomePlanet-Official-Logo-V1.png" alt="HomePlanet" style={mark} />
            <span>
