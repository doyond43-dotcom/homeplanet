                  ...
                  <div key={lead.id} style={leadCard}>
                    ...
                    {lead.status === "Ready for review" ? (
                      ...
                      >
                        ...
                        <div style={{ marginTop: 7, color: "#e0f2fe", fontWeight: 950 }}>
                          Review link not added yet
                        </div>
                        <div style={{ marginTop: 4, color: "#94a3b8", fontSize: 12, lineHeight: 1.4 }}>
                          When the first version is built, paste or send the customer their Live Page review link.
                        </div>
                      </div>
                    ) : null}
                    ...
                    {lead.status === "Approved and live" ? (
                      ...
                      >
                        ...
                        <div style={{ marginTop: 4, color: "#94a3b8", fontSize: 12, lineHeight: 1.4 }}>
                          Send the activation/payment link after the customer approves the Live Page System.
                        </div>
                      </div>
                    ) : null}
