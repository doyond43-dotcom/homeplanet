...
export default function LivePagesHub() {
  ...
  const brandSub: CSSProperties = {
    ...
    color: "#f5c86b",
    whiteSpace: "nowrap",
    textShadow: "0 0 14px rgba(245,200,107,0.22)",
  };
        ...
        >
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                "linear-gradient(90deg, rgba(5,5,5,0.95) 0%, rgba(5,5,5,0.86) 30%, rgba(5,5,5,0.34) 56%, rgba(5,5,5,0.02) 100%)",
            }}
          />
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                "radial-gradient(circle at 20% 20%, rgba(52,211,153,0.16), transparent 34%), radial-gradient(circle at 80% 50%, rgba(14,165,233,0.08), transparent 36%)",
            }}
          />
          ...
          >
            ...
            <p style={{ ...sub, fontSize: 18, maxWidth: 590 }}>
