        ...
        <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <input
              ...
              className="mt-1 w-full rounded-xl border border-white/10 bg-black/40 px-3 py-2 text-xs font-bold text-white outline-none placeholder:text-white/30 focus:border-green-400/50 md:min-w-[280px]"
            />
          </div>
          ...
          <button
            ...
            className="rounded-xl bg-green-400 px-4 py-2 text-xs font-black text-black"
          >
            Add To Route
          </button>
        </div>
