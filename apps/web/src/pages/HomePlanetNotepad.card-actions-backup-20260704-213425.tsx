            ...
            {customers.map((customer) => (
              ...
              >
                ...
                <div className="mt-4 grid grid-cols-3 gap-2">
                  <button onClick={() => createInvoice(customer)} className="rounded-xl border border-purple-300/20 bg-purple-400/15 px-3 py-2.5 text-sm font-bold text-purple-100">
                    Invoice
                  </button>
                  <button onClick={() => sendInvoice(customer)} className="rounded-xl border border-emerald-300/20 bg-emerald-400/15 px-3 py-2.5 text-sm font-bold text-emerald-100">
                    Send
                  </button>
                  <button onClick={() => openCustomerDrawer(customer, null)} className="rounded-xl border border-white/10 bg-white/10 px-3 py-2.5 text-sm font-bold">
                    Open
                  </button>
                </div>
              </article>
