    ...
    <main className="min-h-screen bg-[#090b09] text-white">
      <section className="relative overflow-hidden border-b border-white/10 bg-[#0D0D0D]">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute inset-0 bg-[linear-gradient(90deg,#0D0D0D_0%,#0D0D0D_48%,#0a2412_100%)]" />

          <div className="absolute right-0 top-0 h-full w-[42%] bg-[linear-gradient(145deg,rgba(8,127,35,0.08),rgba(8,127,35,0.34))]" />

          <div className="absolute right-[9%] top-[14%] h-[72%] w-px bg-[#FFD000]/45" />

          <div className="absolute bottom-0 right-0 h-[34%] w-[38%] bg-[linear-gradient(160deg,transparent_0%,rgba(124,252,0,0.05)_100%)]" />
        </div>
