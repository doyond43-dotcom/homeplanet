...
type BlockType = "whoWeAre" | "pricingNote" | "servicePills" | "livePhotoWall" | "localNote" | "bookNow";
...
export default function StarterLivePageCreatorPage() {
  ...
  function handleWallUpload(event: React.ChangeEvent<HTMLInputElement>) {
  ...
  function launchLivePage() {
    ...
    localStorage.setItem(`hp:starter-live-page:${slug}`, JSON.stringify(pageData));
    window.location.href = `/planet/starter/${slug}`;
  }
