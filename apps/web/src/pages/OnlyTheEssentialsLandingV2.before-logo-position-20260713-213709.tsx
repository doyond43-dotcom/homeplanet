          ...
          <header className="flex items-center justify-between gap-4">
            <div className="flex items-center">
              <img
                ...
                className="block h-28 w-64 shrink-0 origin-left translate-x-10 translate-y-3 scale-[1.4] object-contain drop-shadow-[0_0_22px_rgba(244,114,182,0.48)] sm:h-32 sm:w-72 sm:translate-x-14 sm:translate-y-4 sm:scale-[1.45]"
              />
            </div>
