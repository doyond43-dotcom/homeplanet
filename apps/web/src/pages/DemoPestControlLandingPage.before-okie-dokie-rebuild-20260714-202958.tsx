...
const customerReviews: CustomerReview[] = [
  {
    name: "Dee Paris",
    source: "Google",
    text: "Our Team deserves 5 stars. He actually answers his calls. He comes on schedule to do treatments and comes quickly when you need additional service. He is very knowledgeable and answers any questions you have."
  },
  {
    name: "Jimmy Hank Spivey",
    source: "Google",
    text: "Lake Country Pest Control was great. Our Team really knows his stuff. He came in and took care of the problem. He was very knowledgeable and affordable and we will use him for our bimonthly services going forward."
  },
  {
    name: "Bryan Martinez",
    source: "Google",
    text: "Our Team showed up on time, he was very professional and relatable. You can tell he's not just here to get your money and do a job, he genuinely wants to help. Hands down 5 star service."
  },
  {
    name: "Alex",
    source: "Google",
  ...
  },
  {
    name: "Greg McCranie",
    source: "Google",
    text: "Our Team and Ashley are great people to do business with for all your pest control needs. Very responsive and explains everything that will be done to get rid of any pests you may have. Highly recommend them."
  },
  {
    name: "Kristi Cupelli",
    source: "Google",
    text: "We couldn't be happier with the service. Our Team was professional, knowledgeable, and truly went the extra mile to help us with our ant problem. He was very prompt, thorough, and made sure all of our concerns were addressed."
  },
  {
    name: "Nicole Hulen",
    source: "Google",
    text: "Lake Country Pest Control has been a huge help with our fruit fly issue. Our Team is so knowledgeable and gets to the root of the problem. They don't pressure you into contracts like the big name companies and treat you like family."
  },
  {
    name: "Tommy Barroso",
    source: "Google",
    text: "Lake Country Pest Control was awesome, super prompt to answer, and steered me away from services I did not need even though he could have billed me for it. Can't recommend them enough."
  },
  {
    name: "Martin Gallagher",
    source: "Google",
    text: "I've had Lake Country Pest Control address my fire ant problem. They showed up to my house promptly, addressed the problem, gave me a solution, and now we are totally ant free."
  },
  {
    name: "Clare Little",
    source: "Google",
    text: "Our Team's customer service is outstanding and we can tell he genuinely cares about his customers. Our Team is super prompt, thorough, friendly, knowledgeable and professional. We have had no issues with ants or any other pests since we switched to Lake Country Pest Control."
  },
  {
    name: "Victoria Parks",
    source: "Google",
    text: "Our Team and his wife made a special trip out to my house after business hours because of the urgency. I would highly recommend their company for pest control."
  },
  {
    name: "Joseph Hennessey",
    source: "Google",
    text: "Lake Country Pest Control is an exceptional service. Our Team and Ashley go above and beyond and always answer the phones. Couldn't be more happy with my service. 10 out of 10 recommend their service."
  },
  {
    name: "Leslie Fennell",
    source: "Google",
  ...
  },
  {
    name: "David Winter",
    source: "Google",
    text: "Lake Country Pest Control is the best pest control company we have ever had. Our Team is prompt, thorough, very knowledgeable, and we never have a problem. I highly recommend this company to anyone."
  },
  {
    name: "Johnnie Felix",
    source: "Google",
  ...
  },
  {
    name: "Francis Becker",
    source: "Facebook",
    text: "We work with Our Team at Lake Country Pest Control. He handles all our pest issues, is very knowledgeable, and explains everything to us. He has been a blessing. If there is a better pest control company in Okeechobee I haven't found them."
  },
  {
    name: "Jimmy Spivey Jr.",
    source: "Facebook",
    text: "Competitive prices, easy to work with, and the owner is friendly and really cares about the customer's concerns. Our Team worked with us and will continue to take great care of the home going forward."
  },
  {
    name: "Les Fennell",
    source: "Facebook",
  ...
  },
  {
    name: "Clint Howell",
    source: "Facebook",
    text: "Lake Country Pest Control Pest Control offers premier customer service that puts them miles ahead of their competitors. Their family first mentality makes you feel like they are treating their own homes with care and professionalism."
  }
];
...
export default function DemoPestControlLandingPage() {
  useEffect(() => {
    const title = "Lake Country Pest Control Pest Control | Local Pest Control Demo & Mosquito Fogging";
    const description =
      "Lake Country Pest Control Pest Control helps Okeechobee homes, sheds, barns, RVs, mobile homes, and businesses with pest control, mosquito fogging, roaches, ants, rodents, spiders, fleas, ticks, wasps, and more.";
    ...
    setMeta(
      "keywords",
      "Lake Country Pest Control Pest Control, Okeechobee pest control, mosquito fogging Okeechobee, roach control Okeechobee, ant control Okeechobee, rodent control Okeechobee, spider treatment Okeechobee, flea tick pest control, wasp hornet pest control"
    );
    ...
    setPropertyMeta("og:image", "https://www.homeplanet.city/images/homeplanet-your-workflow-live-v1.png");

    setMeta("twitter:card", "summary_large_image");
    setMeta("twitter:title", title);
    setMeta("twitter:description", description);
    setMeta("twitter:image", "https://www.homeplanet.city/images/homeplanet-your-workflow-live-v1.png");
  }, []);
      ...
      <section className="relative overflow-hidden px-4 pb-10 pt-8 text-center sm:px-8 sm:pb-12 sm:pt-10 lg:pb-16 lg:pt-14">
        ...
        <div className="relative mx-auto max-w-6xl">
          ...
          <h1 className="mx-auto mt-5 max-w-4xl text-5xl font-black leading-[0.92] tracking-tight sm:text-7xl lg:text-8xl">
            Pest Problem?
            <br />
            <span className="text-[#66dc3b]">Slap â€™Em.</span>
          </h1>

          <p className="mx-auto mt-5 max-w-2xl text-sm leading-7 text-white/72 sm:mt-6 sm:text-lg sm:leading-8">
            Fast local pest control for homes, rentals, businesses, yards, garages, sheds, and outdoor spaces.
          </p>
          ...
          <div className="mx-auto mt-10 max-w-5xl overflow-hidden rounded-[2rem] border border-white/10 bg-black/40 shadow-[0_0_95px_rgba(31,111,190,0.24)]">
            <div className="relative aspect-[4/3] min-h-[245px] sm:aspect-[16/7] sm:min-h-[300px]">
              <img
                ...
                alt="Lake Country Pest Control Pest Control truck in Okeechobee"
              ...
              <div className="absolute bottom-4 left-4 right-4 text-left sm:bottom-7 sm:left-7">
                ...
                <h2 className="mt-2 max-w-2xl text-2xl font-black leading-tight sm:text-5xl">
                  Local pest control built around fast response.
                </h2>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-white/60">
                Tell Our Team what youâ€™re seeing and where itâ€™s happening.
              </p>
            </div>
      ...
      <section className="mx-auto max-w-6xl px-4 pb-10 sm:px-8 sm:pb-12">
        ...
        <div className="mt-8 grid gap-4 lg:grid-cols-2">
          <article className="rounded-3xl border border-white/10 bg-white/[0.045] p-6 shadow-[0_0_34px_rgba(31,111,190,0.08)] sm:p-7">
            ...
            <p className="mt-5 text-sm leading-7 text-white/72">
              â€œWe work with Our Team at Lake Country Pest Control. He handles all our pest issues,
              ...
              Okeechobee, I haven't found them. Lake Country Pest Control's service and
              professionalism are unbeatable. 5 stars!â€
            </p>
          ...
          <article className="rounded-3xl border border-white/10 bg-white/[0.045] p-6 shadow-[0_0_34px_rgba(31,111,190,0.08)] sm:p-7">
            ...
            <p className="mt-5 text-sm leading-7 text-white/72">
              â€œCompetitive prices, easy to work with, and the owner is friendly
              and really cares about the customer's concerns. This is our rental
              home and we don't live in the same town. Our Team worked with us and
              will continue taking great care of the home going forward. I would
              highly recommend Lake Country Pest Control.â€
            </p>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm font-black text-white">
            <span className="text-[#ffd76a]">5.0 â˜…</span>
              ...
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="mt-2 text-sm text-white/55">
                    5.0 on Google Â· 110 Google reviews Â· Facebook recommendations
                  </p>
                </div>
          ...
          <div className="grid gap-8 lg:grid-cols-[0.78fr_1.22fr] lg:items-start">
            <div>
              ...
              <p className="mt-4 text-sm leading-7 text-white/66">
                Pick the issue, tell Our Team where it is, and send your contact info so he can follow up without you explaining everything twice.
              </p>

              <div className="mt-6 grid gap-3">
                {[
                  ["1", "Pick the pest issue"],
                  ["2", "Tell Our Team where youâ€™re seeing it"],
                  ["3", "Request goes into his work board"],
                  ["4", "Our Team follows up with the next step"]
                ].map(([num, text]) => (
                  <div
                    key={num}
              ...
              {submitted ? (
                <div className="rounded-2xl border border-[#28c765]/30 bg-[#28c765]/10 p-6">
                  ...
                  <p className="mt-2 text-sm leading-6 text-white/70">
                    Our Team now has the details and can follow up with you.
                  </p>
                </div>
              ) : (
                <form onSubmit={submitRequest} className="grid gap-3">
                  ...
                  <textarea
                    ...
                    placeholder="Notes â€” what are you seeing, where, and when did it start?"
                  />
