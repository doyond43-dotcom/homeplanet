...
function buildSuggestion(signal: Signal) {
  ...
  if (signal.preferredTech && !["Preferred Tech / Crew", "No preference"].includes(signal.preferredTech)) {
    return `Customer requested ${signal.preferredTech}. Assign that tech if scheduling allows.`;
  }
...
function mapRow(row: RequestRow): Signal {
  ...
  const preferredTech = readLine(rawNotes, "Preferred Tech / Crew", "No preference");
...
export default function RidgelineIntelligenceDashboard() {
  ...
  const metrics = useMemo(() => {
    ...
    const techRequests = signals.filter((s) =>
      s.preferredTech && !["Preferred Tech / Crew", "No preference", "Not sure"].includes(s.preferredTech)
    ).length;
    ...
    return [
      ...
      { label: "Tech Requests", value: techRequests },
          ...
          <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-sm leading-6 text-zinc-300">
                Live requests, job difficulty, preferred crew, access notes, and next moves for Ridgeline service calls.
              </p>
            </div>
                  ...
                  >
                    ...
                    <button onClick={() => setSelected(signal)} className="mt-4 w-full text-left">
                      <div className="grid gap-2 text-sm text-zinc-300 sm:grid-cols-2">
                        ...
                        <div>Preferred tech: {signal.preferredTech}</div>
                      </div>
          ...
          <aside className="rounded-[2rem] border border-amber-300/15 bg-black p-5">
            ...
            <div className="mt-5 grid gap-3">
              <div className="rounded-2xl bg-white/[0.035] p-4">
                <h3 className="font-black">Tech requests matter.</h3>
                <p className="mt-1 text-sm text-zinc-400">
                  When customers request someone by name, the owner can see who is building trust.
                </p>
              </div>
              ...
              <div className="rounded-2xl bg-white/[0.035] p-4">
                ...
                <p className="mt-1 text-sm text-zinc-400">
                  Photos and access notes help avoid guessing before quoting.
                </p>
              </div>

              <div className="rounded-2xl bg-white/[0.035] p-4">
                <h3 className="font-black">Access details save time.</h3>
                <p className="mt-1 text-sm text-zinc-400">
                  Gate codes, limited access, and customer availability should show before scheduling.
                </p>
              </div>
            </div>
          </aside>
            ...
            <div className="mt-6 space-y-3">
              ...
              <div className="rounded-2xl border border-white/10 bg-zinc-950 p-4">
                ...
                <div className="mt-3 space-y-1 text-sm text-zinc-200">
                  ...
                  <div>Preferred Tech: {selected.preferredTech}</div>
