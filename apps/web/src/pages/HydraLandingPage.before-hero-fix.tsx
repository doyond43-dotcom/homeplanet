  ...
  return (
    <main className="min-h-screen bg-[#061426] text-white">
      <section className="mx-auto max-w-7xl px-6 py-10">
        <div className="relative overflow-hidden rounded-[2rem] border border-cyan-300/20 bg-white/5 shadow-2xl">
          <img
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#061426] via-[#061426]/72 to-[#061426]/20" />
