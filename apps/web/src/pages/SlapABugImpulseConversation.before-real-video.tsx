  ...
  return (
    <main className="min-h-screen bg-[#06111f] px-5 py-6 text-white">
      <section className="mx-auto max-w-md">
        ...
        <button
          className="mb-5 w-full overflow-hidden rounded-3xl border border-[#f04444]/40 bg-[#0b1f3a] text-left shadow-lg"
        >
          <div
            className="h-40 bg-cover bg-center"
            style={{
              backgroundImage:
                "url('/images/slap-a-bug-truck-hero.jpg')",
            }}
          />
          ...
          <div className="p-4">
            ...
            <div className="mt-1 text-sm text-white/70">
              Watch a quick introduction and learn how Slap-A-Bug can help.
            </div>
          </div>
        </button>
