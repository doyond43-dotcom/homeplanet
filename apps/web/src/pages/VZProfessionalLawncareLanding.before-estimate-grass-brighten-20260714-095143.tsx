    ...
    <main className="min-h-screen bg-[#090b09] text-white">
      ...
      >
        <div className="pointer-events-none absolute inset-0">
          ...
          <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(9,11,9,0.84)_0%,rgba(9,11,9,0.72)_34%,rgba(9,11,9,0.42)_58%,rgba(9,11,9,0.16)_100%)]" />

          <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(9,11,9,0.08)_0%,transparent_44%,rgba(9,11,9,0.18)_100%)]" />
        </div>
