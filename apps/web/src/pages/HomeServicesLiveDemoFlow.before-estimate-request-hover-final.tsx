  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <section id="ridgeline-estimate" className="bg-[#050505] px-4 py-14">
        <div className="mx-auto max-w-5xl rounded-[2rem] border border-orange-400/40 bg-[linear-gradient(145deg,rgba(18,18,20,.92),rgba(5,5,5,.96))] p-6 shadow-[0_0_34px_rgba(180,83,9,0.14),0_28px_80px_rgba(0,0,0,.55)] sm:p-8">
