            ...
            {customers.map((customer) => (
              ...
              >
                ...
                <div className="mt-4 grid grid-cols-2 gap-2 sm:grid-cols-4">
                  ...
                  <button onClick={() => navigateCustomer(customer)} className={`rounded-xl border px-3 py-2.5 text-sm font-bold ${customer.address ? "border-emerald-300/20 bg-emerald-400/15 text-emerald-100" : "border-white/10 bg-white/10 text-white/70"}`}>
                    Navigate
                  </button>
            ...
            {openCustomer ? (
              <div>
                ...
                <div className="grid gap-3">
                  ...
                  <label className="grid gap-2">
                    <span className="text-xs font-black uppercase tracking-[0.18em] text-white/40">Address</span>
                    <input
                      className="min-w-0 w-full rounded-2xl border border-white/10 bg-black/40 px-4 py-3 text-white outline-none"
                    ...
                    {!openCustomer.address && (
                      <span className="text-[11px] font-semibold text-white/35">
                        Add an address to make Navigate work from the card.
                      </span>
                    )}
                  </label>
