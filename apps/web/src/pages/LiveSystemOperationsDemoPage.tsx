          ...
          <div className="rounded-[2rem] bg-white/[0.04] p-6">
            ...
            <div className="mt-8">
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-3">
                {[
                  ["/images/live-system-electrical-before.jpg.png", "Before"],
                  ["/images/live-system-electrical-during.jpg.png", "During"],
                  ["/images/live-system-electrical-after.jpg.png", "After"],
                ].map(([src, label]) => (
                  <div
                    key={label}
                  ...
                  >
                    ...
                    <div className="p-3 text-center text-sm font-black text-slate-300">
                      {label} Photo
                    </div>
                  </div>
                ))}
