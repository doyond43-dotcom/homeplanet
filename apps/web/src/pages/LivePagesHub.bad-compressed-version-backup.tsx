    ...
    <main style={page}>
      <div style={wrap}>
        ...
        <section style={section}>
          ...
          <p style={{ ...sub, fontSize: 15 }}>
            A pressure washing company, pest control company, auto repair shop, restaurant, cleaner,
            barber, and local service business do not run the same way. Your Live Page is shaped around
            the main customer action that matters most to your business.
          </p>

          <div style={grid}>
            {[
              ["Local services", "Turn messy messages into clear requests, photos, estimates, schedules, and updates."],
              ["Appointment-based work", "Give customers a simple way to request time, explain the need, and stay organized."],
              ["Food, hospitality, and walk-in flow", "Create awareness between the customer side, staff side, and owner side."],
              ["Custom local workflows", "When the business is different, the system adapts around the real workflow instead of forcing a template."],
            ].map(([title, body]) => (
              <article key={title} style={card}>
