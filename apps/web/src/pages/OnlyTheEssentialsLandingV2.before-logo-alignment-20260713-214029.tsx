          ...
          <header className="flex items-center justify-between gap-4">
            <div className="relative h-36 w-[26rem] shrink-0 sm:h-40 sm:w-[30rem]">
              <img
                ...
                className="absolute left-16 top-5 h-auto w-[25rem] max-w-none object-contain drop-shadow-[0_0_24px_rgba(244,114,182,0.52)] sm:left-20 sm:top-6 sm:w-[29rem]"
              />
            </div>
          ...
          <div className="mt-6 grid gap-3 lg:grid-cols-3">
            ...
            <div className="grid gap-3 rounded-2xl border border-dashed border-pink-300/30 bg-black/30 p-4 text-sm text-zinc-300 lg:col-span-3 lg:grid-cols-3">
              <label className="block">
                ...
                <p className="mb-3 text-xs leading-5 text-zinc-400">Optional ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â show problem areas, rooms, pets, or mess level.</p>
          ...
          <div className="relative">
            ...
            <div className="mt-10 grid gap-5 lg:grid-cols-2">
              <article className="flex h-full flex-col rounded-[1.75rem] border border-white/10 bg-black/25 p-6 shadow-xl shadow-black/20 transition duration-300 hover:-translate-y-1 hover:border-pink-300/25 sm:p-8">
                ...
                >
                  ÃƒÂ¢Ã‹Å“Ã¢â‚¬Â¦ÃƒÂ¢Ã‹Å“Ã¢â‚¬Â¦ÃƒÂ¢Ã‹Å“Ã¢â‚¬Â¦ÃƒÂ¢Ã‹Å“Ã¢â‚¬Â¦ÃƒÂ¢Ã‹Å“Ã¢â‚¬Â¦
                </p>

                <blockquote className="mt-6 flex-1 font-serif text-2xl italic leading-9 text-white sm:text-[1.7rem]">
                  ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œHighly recommend! Kaitlyn did a great job helping us get back on
              ...
              <article className="flex h-full flex-col rounded-[1.75rem] border border-white/10 bg-black/25 p-6 shadow-xl shadow-black/20 transition duration-300 hover:-translate-y-1 hover:border-pink-300/25 sm:p-8">
                ...
                <blockquote className="mt-6 flex-1 font-serif text-2xl italic leading-9 text-white sm:text-[1.7rem]">
                  ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œI came home to super clean floors, sparkling bathrooms, beds made,
                  sinks cleaned... Everything back in order! Highly recommend.ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â
                </blockquote>
