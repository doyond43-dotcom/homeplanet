...
function GreenPigIcon() {
  return (
    <span
      className="inline-flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl border border-green-400/25 bg-green-400/10 shadow-[0_0_34px_rgba(74,222,128,0.34)]"
      aria-hidden="true"
    >
      <img
        src="/images/homeplanet-green-piggy-bank.png?v=20260629-105551"
        alt=""
        className="h-14 w-14 object-contain drop-shadow-[0_0_14px_rgba(74,222,128,0.75)]"
      />
    </span>
  );
}
