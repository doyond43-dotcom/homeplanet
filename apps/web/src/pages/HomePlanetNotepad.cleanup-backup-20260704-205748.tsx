                      ...
                      <div className="rounded-2xl border border-purple-300/20 bg-purple-400/10 p-4">
                        {openCustomer.invoice ? (
                          <>
                            ...
                            <pre className="mt-3 max-h-32 max-w-full overflow-auto whitespace-pre-wrap break-words rounded-2xl border border-white/10 bg-black/35 p-3 text-xs leading-5 text-white/70">
