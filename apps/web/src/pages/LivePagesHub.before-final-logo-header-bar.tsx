...
export default function LivePagesHub() {
  ...
  const nav: CSSProperties = {
    ...
    background:
      "radial-gradient(circle at 7% 50%, rgba(56,189,248,0.22), transparent 19%), radial-gradient(circle at 42% 120%, rgba(37,99,235,0.18), transparent 30%), radial-gradient(circle at 86% 50%, rgba(52,211,153,0.10), transparent 24%), rgba(0,0,0,0.66)",
    padding: "12px 14px",
    boxShadow:
      "0 20px 70px rgba(0,0,0,0.42), 0 0 34px rgba(56,189,248,0.10), inset 0 1px 0 rgba(255,255,255,0.06)",
  };
  ...
  const planetRing: CSSProperties = {
    ...
    height: 18,
    borderRadius: 999,
    border: "3px solid rgba(52,211,153,0.94)",
    transform: "rotate(-19deg)",
    boxShadow:
      "0 0 16px rgba(52,211,153,0.36), inset 0 0 8px rgba(52,211,153,0.18)",
  };
  ...
  const navBtn: CSSProperties = {
    ...
    background:
      "linear-gradient(135deg, rgba(52,211,153,1), rgba(16,185,129,0.90))",
    color: "#04110c",
    padding: "12px 20px",
    textDecoration: "none",
    fontWeight: 1000,
    fontSize: 13,
    boxShadow: "0 0 30px rgba(52,211,153,0.32)",
  };
      ...
      <div style={wrap}>
        <nav style={nav}>
          <Link to="/planet/live-pages" style={brand}>
            ...
            <span>
              <span style={{ display: "block", fontWeight: 1000, fontSize: 17, lineHeight: 1 }}>
                HomePlanet
              </span>
              <span style={{ display: "block", marginTop: 3, color: "#38bdf8", fontSize: 12, fontWeight: 900, letterSpacing: "0.08em" }}>
