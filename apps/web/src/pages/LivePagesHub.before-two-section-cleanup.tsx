  ...
  return (
    <main style={page}>
      <div style={wrap}>
        ...
        <section style={section}>
          <div style={eyebrow}>REAL WORKFLOW EXAMPLES</div>
          <h2 style={h2}>The system changes based on the business.</h2>

          <div style={grid}>
            {examples.map((example) => (
              <article key={example.title} style={card}>
                <h3 style={{ margin: 0, fontSize: 22 }}>{example.title}</h3>
                <p style={{ margin: "8px 0 0", color: "#94a3b8", lineHeight: 1.5, fontSize: 14 }}>
                  {example.body}
                </p>
                <div style={chipWrap}>
                  {example.chips.map((chipText) => (
                    <span key={chipText} style={chip}>
                      {chipText}
                    </span>
                  ))}
                </div>
        ...
        <section style={section}>
          <div style={eyebrow}>COMMON QUESTIONS</div>
          <h2 style={h2}>Simple answers before you message.</h2>

          <div style={grid}>
            {faqs.map((faq) => (
              <article key={faq.q} style={card}>
                <h3 style={{ margin: 0, fontSize: 18 }}>{faq.q}</h3>
                <p style={{ margin: "8px 0 0", color: "#94a3b8", lineHeight: 1.5, fontSize: 14 }}>
                  {faq.a}
                </p>
              </article>
