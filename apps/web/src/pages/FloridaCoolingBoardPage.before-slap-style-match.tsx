...
type CoolingStage = "NEW REQUEST" | "NEEDS FOLLOW-UP" | "ESTIMATE" | "SCHEDULE" | "REVIEW";
...
const requests: CoolingRequest[] = [
  {
    ...
    urgency: "Urgent",
    schedulePlaceholder: "Example: Today 3 PM",
  ...
  },
  {
    ...
    urgency: "Soon",
    schedulePlaceholder: "Example: Tomorrow morning",
    paymentStatus: "Not sent",
    proofStatus: "Not added",
  ...
  },
  {
    ...
    urgency: "Estimate",
    schedulePlaceholder: "Example: Thursday 10 AM",
    paymentStatus: "Not sent",
    proofStatus: "Not added",
...
export default function FloridaCoolingBoardPage() {
  ...
  function openText() {
    window.location.href = `sms:${active.phone}?&body=${encodeURIComponent(readyText)}`;
  }

  const stats = [
    { label: "ACTIVE REQUESTS", value: "3" },
    { label: "URGENT COOLING", value: "1" },
    { label: "ESTIMATES", value: "1" },
          ...
          <section className="overflow-hidden rounded-[2rem] border border-sky-500/30 bg-[#06111d]">
            <div className="border-b border-sky-500/20 p-5 md:p-7">
              ...
              <div className="mt-6 grid gap-3 md:grid-cols-3">
                ...
                <button className="inline-flex items-center justify-center rounded-2xl bg-green-500 px-5 py-4 font-black text-black transition hover:bg-green-400">
                  Schedule
                </button>
              </div>
            </div>
            ...
            <div className="p-5 md:p-7">
              ...
              <div className="mt-5 grid gap-5 md:grid-cols-2">
                <div className="rounded-3xl border border-sky-500/20 bg-[#030908] p-5">
                  ...
                  <input
                    defaultValue={active.schedulePlaceholder}
                    className="mt-4 w-full rounded-2xl border border-sky-500/20 bg-[#06111d] px-4 py-4 text-white outline-none"
                  />

                  <button className="mt-4 w-full rounded-2xl bg-green-500 px-5 py-4 font-black text-black transition hover:bg-green-400">
                    Mark Scheduled
                  </button>
                </div>
                ...
                <div className="rounded-3xl border border-sky-500/20 bg-[#030908] p-5">
                  ...
                  <button className="mt-5 w-full rounded-2xl border border-sky-500/30 bg-[#06111d] px-5 py-4 font-black transition hover:bg-sky-400/10">
                    Send Payment Message
                  </button>

                  <button className="mt-3 w-full rounded-2xl bg-green-500 px-5 py-4 font-black text-black transition hover:bg-green-400">
                    Mark Paid
                  </button>
                </div>
                ...
                <div className="rounded-3xl border border-sky-500/20 bg-[#030908] p-5">
                  ...
                  <button className="mt-3 w-full rounded-2xl border border-green-500/35 bg-green-500/12 px-5 py-4 font-black text-green-200 transition hover:bg-green-500/18">
                    Ask For Review
                  </button>
                </div>
                ...
                <div className="rounded-3xl border border-sky-500/20 bg-[#030908] p-5">
                  ...
                  <button className="mt-4 w-full rounded-2xl border border-sky-500/30 bg-[#06111d] px-5 py-4 font-black transition hover:bg-sky-400/10">
                    Save Notes
                  </button>
                </div>
              </div>
