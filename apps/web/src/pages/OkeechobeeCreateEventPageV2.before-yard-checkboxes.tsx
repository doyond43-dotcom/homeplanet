...
export default function OkeechobeeCreateEventPageV2() {
  ...
  const [yardHelpType, setYardHelpType] = useState("Garden help");
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const guidedDetails = [
      ...
      isYard ? `Yard help needed: ${yardHelpType}` : "",
      `Urgency: ${urgency}`,
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          {isYard && (
            <section style={styles.section}>
              ...
              <label style={styles.label}>
                What kind of outdoor help?
                <select style={styles.input} value={yardHelpType} onChange={(e) => setYardHelpType(e.target.value)}>
