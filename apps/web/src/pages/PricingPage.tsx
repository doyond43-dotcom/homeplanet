      ...
      <div className="mx-auto max-w-6xl">
        ...
        {!selectedTier ? (
          <>
            ...
            <div className="mb-10 rounded-2xl border border-zinc-800 bg-zinc-900 p-4 text-center sm:mb-12 sm:p-6">
            ...
            <div className="grid gap-4 sm:gap-6 md:grid-cols-3">
              {tiers.map((tier) => (
                <div
                  key={tier.slug}
                  className="flex flex-col rounded-2xl border border-zinc-800 bg-zinc-900 p-4 sm:p-6"
                >
            ...
            <div className="mt-12 rounded-2xl border border-zinc-800 bg-zinc-900 p-4 text-center sm:mt-16 sm:p-6">
              <h2 className="mb-2 text-xl font-semibold sm:text-2xl">
                🚀 System Activation
              </h2>
              ...
              <div className="mb-2 text-2xl font-bold text-blue-400 sm:text-3xl">
                $997 – $2,500 one-time
              </div>
          ...
          <div className="rounded-3xl border border-zinc-800 bg-zinc-950 p-4 sm:p-6 md:p-8">
            ...
            >
              <div className="min-w-0">
                ...
                <div className="mt-8 rounded-2xl border border-zinc-800 bg-zinc-900 p-4 sm:p-5">
                ...
                <div className="mt-5 rounded-2xl border border-zinc-800 bg-zinc-900 p-4 sm:p-5">
                  <div className="text-sm font-semibold uppercase tracking-[0.22em] text-zinc-500">
                    What this plan does
                  </div>
                  <p className="mt-3 text-sm leading-7 text-zinc-300">
