...
export default function LivePagesHub() {
  ...
  const mark: CSSProperties = {
    ...
    objectFit: "contain",
    filter:
      "drop-shadow(0 0 18px rgba(56,189,248,0.22)) drop-shadow(0 0 12px rgba(52,211,153,0.10))",
  };
      ...
      <div style={wrap}>
        <nav style={nav}>
          <Link to="/planet/live-pages" style={brand}>
            <img
              src="/images/homeplanet_live_pages_logo_TRANSPARENT_LOCKED.png"
              alt="HomePlanet Live Pages for local business"
              style={mark}
            />
          </Link>
