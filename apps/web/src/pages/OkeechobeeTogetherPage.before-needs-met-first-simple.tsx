      ...
      <section style={styles.card}>
        ...
        <section id="projects" style={styles.board}>
          <div style={{
            ...
            background: "linear-gradient(135deg, rgba(57,255,20,0.10) 0%, rgba(10,10,10,0.95) 70%)",
            ...
            <h2 style={{ ...styles.sectionTitle, margin: "0 0 8px" }}>
              Active Community Needs
            </h2>

            <p style={{ margin: 0, color: "#d5d5d5", lineHeight: 1.6, fontSize: 16 }}>
              These are local needs the community can still respond to.
            </p>
          </div>
        ...
        <section style={{ ...styles.board, marginTop: 34 }}>
          <div style={{
            marginBottom: 18,
            padding: "18px 18px 16px",
            borderRadius: 20,
            border: "1px solid rgba(255,196,87,0.34)",
            background: "linear-gradient(135deg, rgba(255,196,87,0.13) 0%, rgba(10,10,10,0.95) 70%)",
            boxShadow: "0 12px 30px rgba(0,0,0,0.22)",
          }}>
            <div style={{
              display: "inline-flex",
            ...
            <p style={{ margin: 0, color: "#d5d5d5", lineHeight: 1.6, fontSize: 16 }}>
              A look at local needs, volunteer help, materials, and outcomes already completed.
            </p>
          </div>
          ...
          <div style={styles.list}>
            {completedEvents.length === 0 ? (
              <div style={styles.emptyCard}>
                Completed projects will show here once a need is resolved.
              </div>
            ) : (
