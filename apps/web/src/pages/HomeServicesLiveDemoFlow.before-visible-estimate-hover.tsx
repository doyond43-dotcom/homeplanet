  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <section id="ridgeline-estimate" className="bg-[#050505] px-4 py-14">
        <div className="mx-auto max-w-5xl rounded-[2rem] border border-orange-400/35 bg-[linear-gradient(145deg,rgba(18,18,20,.92),rgba(5,5,5,.96))] p-6 shadow-[0_0_30px_rgba(180,83,9,0.12),0_28px_80px_rgba(0,0,0,.55)] transition-all duration-200 hover:border-orange-400/70 hover:shadow-[0_0_60px_rgba(180,83,9,0.28),0_28px_80px_rgba(0,0,0,.55)] sm:p-8">
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-14 rounded-[2rem] border border-orange-400/20 bg-orange-500/10 p-6 text-center">
            ...
            <div className="mt-7 flex flex-col justify-center gap-3 sm:flex-row">
              ...
              <a
                href={`sms:${phone}`}
                className="rounded-xl border border-orange-900/45 bg-black px-7 py-4 text-xs font-black uppercase tracking-[0.22em] text-white hover:border-orange-500/45 hover:bg-orange-950/25 hover:shadow-[0_0_20px_rgba(180,83,9,0.18)]"
              >
                Text Ridgeline
              </a>
            </div>
      ...
      <footer className="border-t border-white/10 bg-black px-4 pb-20 pt-12 text-center">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
            ...
            <a
              href={`sms:${phone}`}
              className="rounded-xl border border-orange-900/45 bg-white/[0.04] px-8 py-4 text-xs font-black uppercase tracking-[0.2em] text-white hover:border-orange-500/45 hover:bg-orange-950/25 hover:shadow-[0_0_20px_rgba(180,83,9,0.18)]"
            >
              Text Ridgeline
            </a>
          </div>
