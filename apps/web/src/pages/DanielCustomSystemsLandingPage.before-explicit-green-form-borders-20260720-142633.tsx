  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#020706] text-white">
      ...
      <div className="relative mx-auto w-full max-w-[1120px] px-5 pb-20 pt-6 sm:px-8 lg:px-10 lg:pt-8">
        {/* HEADER */}
        <header className="flex items-center justify-between gap-4 border-b border-[#80df00]/12 pb-5">
          <a
          ...
          <section id="custom-system-request" className="pt-16 sm:pt-20">
            <div className="overflow-hidden rounded-[2rem] border border-[#80df00]/30 bg-[linear-gradient(135deg,rgba(6,14,9,0.98),rgba(0,5,3,0.98))] shadow-[0_24px_80px_rgba(0,0,0,0.45)]">
              ...
              <div className="grid lg:grid-cols-[0.76fr_1.24fr]">
                <div className="border-b border-[#80df00]/12 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:border-[#80df00]/12">
                ...
                <form onSubmit={submitRequest} className="p-6 sm:p-8">
                  <div className="grid gap-3 sm:grid-cols-2">
                    <label className="block">
                      ...
                      <input
                        ...
                        required
                        className="min-h-[56px] w-full rounded-2xl border border-[#80df00]/18 bg-black/50 px-4 text-white outline-none placeholder:text-white/32 focus:border-[#80df00]"
                      />
                    </label>
                  ...
                  <label className="mt-4 block">
                    ...
                    <textarea
                      ...
                      className="min-h-[150px] w-full resize-y rounded-2xl border border-[#80df00]/18 bg-black/50 px-4 py-4 text-white outline-none placeholder:text-white/32 focus:border-[#80df00]"
                    />
                  </label>
                          ...
                          <button
                            ...
                            className={`min-h-[54px] rounded-2xl border px-4 py-3 text-left text-sm font-black transition ${
                              active
                                ...
                                : "border-[#80df00]/16 bg-black/35 text-white/72 hover:border-[#80df00]/34 hover:bg-[#80df00]/[0.025]"
                            }`}
                          >
                  ...
                  <div className="mt-3 grid gap-3 sm:grid-cols-2">
                    ...
                    <label className="block">
                      ...
                      <select
                        ...
                        required
                        className="min-h-[56px] w-full cursor-pointer rounded-2xl border border-[#80df00]/18 bg-black/50 px-4 text-white outline-none focus:border-[#80df00]"
                      >
                  ...
                  <label className="mt-3 block">
                    ...
                    <textarea
                      ...
                      className="min-h-[120px] w-full resize-y rounded-2xl border border-[#80df00]/18 bg-black/50 px-4 py-4 text-white outline-none placeholder:text-white/32 focus:border-[#80df00]"
                    />
                  </label>
