        ...
        <div className="relative mx-auto max-w-7xl px-5 py-8 sm:px-8 lg:px-12">
          <header className="flex items-center justify-between gap-4">
            <div className="flex items-center">
              <img
                src="/images/only-the-essentials-premium-logo-dark.png"
                alt="Only The Essentials Cleaning"
                className="h-28 w-28 rounded-[1.5rem] border border-pink-300/40 bg-black/35 p-1 object-contain shadow-[0_0_32px_rgba(236,72,153,0.32)] backdrop-blur-sm sm:h-36 sm:w-36"
              />
            </div>
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:px-12">
        ...
        >
          ...
          <div className="relative">
            ...
            <div className="mt-6 flex items-center justify-center gap-3 rounded-2xl border border-white/[0.07] bg-black/20 px-5 py-4 text-center">
              <span
                aria-hidden="true"
                className="h-2.5 w-2.5 shrink-0 rounded-full bg-pink-300 shadow-[0_0_16px_rgba(244,114,182,0.85)]"
              />

              <p className="text-sm font-semibold leading-6 text-zinc-300">
                These recommendations come from real customer experiences.
              </p>
            </div>
          </div>
        </section>
