...
export default function LivePagesHub() {
  ...
  const nav: CSSProperties = {
    ...
    background:
      "radial-gradient(circle at 12% 50%, rgba(52,211,153,0.16), transparent 28%), rgba(0,0,0,0.58)",
  ...
  const mark: CSSProperties = {
    ...
    borderRadius: 999,
    background:
      "radial-gradient(circle at 35% 30%, #bbf7d0, #34d399 34%, #064e3b 62%, #020617 86%)",
    boxShadow:
      "0 0 28px rgba(52,211,153,0.42), inset 0 0 12px rgba(255,255,255,0.18)",
        ...
        <nav style={nav}>
          <Link to="/planet/live-pages" style={brand}>
            ...
            <span>
              ...
              <span style={{ display: "block", marginTop: 3, color: "#86efac", fontSize: 10, fontWeight: 850, letterSpacing: "0.08em" }}>
