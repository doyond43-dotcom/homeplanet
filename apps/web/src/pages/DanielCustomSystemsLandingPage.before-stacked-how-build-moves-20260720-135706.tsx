                ...
                <form onSubmit={submitRequest} className="p-6 sm:p-8">
                  <div className="grid gap-3 sm:grid-cols-2">
                    <label className="block">
                      ...
                      <input
                        ...
                        required
                        className="min-h-[56px] w-full rounded-2xl border border-white/16 bg-black/50 px-4 text-white outline-none placeholder:text-white/32 focus:border-[#80df00]"
                      />
                    </label>
                  ...
                  <label className="mt-4 block">
                    ...
                    <textarea
                      ...
                      className="min-h-[150px] w-full resize-y rounded-2xl border border-white/16 bg-black/50 px-4 py-4 text-white outline-none placeholder:text-white/32 focus:border-[#80df00]"
                    />
                  </label>
                          ...
                          <button
                            ...
                            className={`min-h-[54px] rounded-2xl border px-4 py-3 text-left text-sm font-black transition ${
                              active
                                ...
                                : "border-white/14 bg-black/35 text-white/72 hover:border-[#80df00]/40"
                            }`}
                          >
                  ...
                  <div className="mt-3 grid gap-3 sm:grid-cols-2">
                    ...
                    <label className="block">
                      ...
                      <select
                        ...
                        required
                        className="min-h-[56px] w-full cursor-pointer rounded-2xl border border-white/16 bg-black/50 px-4 text-white outline-none focus:border-[#80df00]"
                      >
                  ...
                  <label className="mt-3 block">
                    ...
                    <textarea
                      ...
                      className="min-h-[120px] w-full resize-y rounded-2xl border border-white/16 bg-black/50 px-4 py-4 text-white outline-none placeholder:text-white/32 focus:border-[#80df00]"
                    />
                  </label>
        ...
        <section id="how-it-works" className="pt-16 sm:pt-20">
          <div className="grid gap-7 lg:grid-cols-[0.85fr_1.15fr] lg:items-end">
            <div>
              ...
              <h2 className="mt-4 max-w-[600px] text-4xl font-black leading-[0.95] tracking-[-0.05em] sm:text-5xl">
