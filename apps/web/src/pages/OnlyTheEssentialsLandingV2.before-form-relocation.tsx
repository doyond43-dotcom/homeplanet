      ...
      <section className="relative border-b border-pink-300/10">
        ...
        <div className="relative mx-auto max-w-7xl px-5 py-8 sm:px-8 lg:px-12">
          ...
          <div className="grid items-center gap-10 py-16 lg:grid-cols-[1fr_0.9fr] lg:py-24">
            ...
            <section className="mt-10 rounded-[2rem] border border-pink-300/20 bg-pink-950/20 p-5 shadow-2xl shadow-pink-950/30">
              <p className="text-xs font-black uppercase tracking-[0.32em] text-pink-300">
                Get My Cleaning Quote
              </p>

              <div className="mt-5 grid gap-3">
                <select className="w-full rounded-2xl border border-white/10 bg-black/40 px-4 py-4 text-sm text-white outline-none">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <select className="rounded-2xl border border-white/10 bg-black/40 px-4 py-4 text-sm text-white outline-none">
                ...
                <input className="w-full rounded-2xl border border-white/10 bg-black/40 px-4 py-4 text-sm text-white outline-none" placeholder="Your Name" />
                <input className="w-full rounded-2xl border border-white/10 bg-black/40 px-4 py-4 text-sm text-white outline-none" placeholder="Phone Number" />

                <div className="rounded-2xl border border-dashed border-pink-300/30 bg-black/30 p-4 text-sm text-zinc-300">
                  Upload Photos
                  <input type="file" multiple className="mt-3 block w-full text-xs text-zinc-400" />
                </div>

                <label className="flex gap-3 rounded-2xl border border-white/10 bg-black/30 p-4 text-xs leading-5 text-zinc-300">
                  <input type="checkbox" className="mt-1" />
                  I understand final pricing depends on home size, condition, pets, and requested services.
                </label>

                <button className="rounded-2xl bg-pink-400 py-4 text-sm font-black uppercase tracking-[0.22em] text-black">
                  Request My Quote
                </button>
              </div>
            </section>
