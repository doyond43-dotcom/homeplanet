...
export default function VZProfessionalLawncareLanding() {
  ...
  return (
    <main className="min-h-screen bg-[#090b09] text-white">
      <header className="border-b border-white/10 bg-[#090b09]/95">
        <div className="mx-auto flex min-h-[78px] max-w-[1380px] items-center justify-between gap-4 px-5 sm:px-8 lg:px-10">
          <a href="/vz" className="min-w-0 text-white no-underline">
            ...
            <p className="mt-1 text-[9px] font-bold uppercase tracking-[0.26em] text-white/45">
          ...
          <div className="flex shrink-0 items-center gap-2">
            <a
              href={`sms:${phone}`}
              className="inline-flex min-h-11 items-center justify-center gap-2 rounded-full border border-white/15 px-4 text-[10px] font-black uppercase tracking-[0.14em] text-white transition hover:border-[#91e84d]/60 hover:text-[#91e84d]"
            >
            ...
            <a
              href={`tel:${phone}`}
              className="inline-flex min-h-11 items-center justify-center gap-2 rounded-full bg-[#91e84d] px-4 text-[10px] font-black uppercase tracking-[0.14em] text-[#10140d] transition hover:bg-[#a8f56b]"
            >
              <Phone size={15} />
              <span className="hidden sm:inline">Call Eric</span>
      ...
      <section className="relative overflow-hidden border-b border-white/10">
        ...
        <div className="relative mx-auto flex min-h-[720px] max-w-[1380px] items-center px-5 py-20 sm:px-8 lg:px-10 lg:py-24">
          <div className="max-w-[980px]">
            ...
            <h1 className="max-w-[1000px] text-[clamp(3.7rem,8vw,8rem)] font-black uppercase leading-[0.84] tracking-[-0.075em]">
              Professional care
