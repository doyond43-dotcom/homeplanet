const packages = [
  ...
  },
  {
    ...
    image: "/images/stay-showcase-living-room.jpg",
  },
];

export default function StayExperienceShowcasePage() {
  return (
    <main className="min-h-screen bg-[#071019] text-white">
      <section
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(7,16,25,0.55), rgba(7,16,25,0.92)), url('/images/stay-showcase-hero.jpg')",
