      ...
      <div style={wrap}>
        <nav style={nav}>
          <Link to="/planet/live-pages" style={brand}>
            ...
            <span>
              <span style={{ display: "block", fontWeight: 1000, fontSize: 13, lineHeight: 1 }}>
                HomePlanet
              </span>
              <span style={{ display: "block", marginTop: 3, color: "#93c5fd", fontSize: 10, fontWeight: 850, letterSpacing: "0.08em" }}>
