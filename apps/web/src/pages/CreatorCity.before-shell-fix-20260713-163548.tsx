...
<section
        ...
        <section className="cc-work-section" id="how-it-works">
      ...
      <section className="cc-ecosystem">
        <div className="cc-shell">
      ...
      <section className="cc-proof">
        <div className="cc-shell">
          ...
          <section className="cc-direction-preview">
            <div className="cc-kicker">Built on HomePlanet</div>

            <h2>
              {selectedDirection === "community"
                ? "Bring people, needs, and local action together."
                : selectedDirection === "organization"
                  ? "Give your people, projects, and communication one connected place."
                  : "Build something completely around the way you already work."}
            </h2>

            <p>
              {selectedDirection === "community"
                ? "Organize needs, offers, events, volunteers, paid local work, updates, proof, and outcomes without losing where anything started."
                : selectedDirection === "organization"
                  ? "Connect members, projects, tasks, communication, updates, decisions, proof, and history inside one working system."
                  : "Start with the real problem, workflow, or idea. HomePlanet shapes the system around it instead of forcing it into a generic template."}
            </p>

            <div className="cc-direction-preview-path">
              {selectedDirection === "community"
        ...
        <div className="cc-shell">
          <h2>
            {selectedDirection === "business"
              ...
              : selectedDirection === "community"
                ? "Build the place your community can act from."
                : selectedDirection === "organization"
                  ? "Build the system your organization works inside."
                  : "Build the system that does not exist yet."}
            <br />
            <span>
              {selectedDirection === "business"
                ? "Run the work from underneath."
                : "Keep every next action and outcome connected."}
            </span>
          </h2>

          <p>
            {selectedDirection === "business"
              ? "Start with the public entrance. Grow the system around the real way your business and customers already work."
              : selectedDirection === "community"
                ? "Start with real needs, offers, people, and local action. Keep the conversations, coordination, money, proof, and outcomes together."
                : selectedDirection === "organization"
                  ? "Start with your people and projects. Connect communication, responsibilities, updates, proof, and history in one place."
                  : "Start with what is happening today. HomePlanet shapes the system around the way the work really needs to move."}
          </p>
