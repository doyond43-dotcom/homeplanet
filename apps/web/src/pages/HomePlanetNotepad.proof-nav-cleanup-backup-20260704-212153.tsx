        ...
        <section id="add-customer" className="rounded-[1.6rem] border border-white/10 bg-white/[0.035] p-4 shadow-xl shadow-black/20">
          <div className="mb-3 flex items-center justify-between gap-3">
            ...
            <button
              ...
              className="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[11px] font-black uppercase tracking-[0.14em] text-white/40 hover:border-emerald-300/30 hover:text-emerald-100"
              type="button"
            >
              Reset Demo
            </button>
