        ...
        >
          ...
          >
            ...
            <div className="ys-review-notice">
              <strong>No payment or publishing happens yet.</strong>
              <p>
                This review confirms the customer experience before we connect
                permanent saving, pricing, payment, and the public page.
              </p>
            </div>
            ...
            <div className="ys-review-actions">
              ...
              <button
                ...
                onClick={() =>
                  window.alert(
                    "The page looks ready. Permanent saving, payment, and publishing are the next connection.",
                  )
                }
              >
