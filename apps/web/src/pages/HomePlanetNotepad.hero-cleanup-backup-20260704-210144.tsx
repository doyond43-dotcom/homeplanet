            ...
            {customers.map((customer) => (
              ...
              >
                ...
                <div className="mt-4 grid grid-cols-3 gap-2">
                  ...
                  <button onClick={() => openCustomerDrawer(customer, null)} className="rounded-xl border border-white/10 bg-white/10 px-3 py-3 text-sm font-bold">
                    Open
                  </button>
                </div>
              </article>
                      ...
                      <div className="rounded-2xl border border-purple-300/20 bg-purple-400/10 p-4">
                        {openCustomer.invoice ? (
                          <>
                            ...
                            <pre className="mt-3 max-h-24 max-w-full overflow-auto whitespace-pre-wrap break-words rounded-2xl border border-white/10 bg-black/35 p-3 text-xs leading-5 text-white/65">
