      ...
      <main className="relative mx-auto flex w-full max-w-6xl flex-col gap-6 px-4 py-6 sm:px-6 lg:px-8">
        ...
        <section id="add-customer" className="rounded-[1.6rem] border border-white/10 bg-white/[0.035] p-4 shadow-xl shadow-black/20">
          ...
          <div className="grid gap-3 lg:grid-cols-[1fr_0.75fr_0.75fr_0.55fr]">
            ...
            <input
              className="rounded-2xl border border-white/10 bg-black/40 px-4 py-3.5 text-white outline-none placeholder:text-white/35 focus:border-emerald-300/50 lg:col-span-3"
            ...
            {customers.map((customer) => (
              ...
              >
                ...
                <div className="mt-4 grid grid-cols-2 gap-2 sm:grid-cols-4">
                  <button onClick={() => callCustomer(customer)} className="rounded-xl border border-white/10 bg-white/10 px-3 py-2.5 text-sm font-bold">
                    Call
                  </button>
                  <button onClick={() => textCustomer(customer)} className="rounded-xl border border-white/10 bg-white/10 px-3 py-2.5 text-sm font-bold">
                    Text
                  </button>
                  <button onClick={() => navigateCustomer(customer)} className="rounded-xl border border-emerald-300/20 bg-emerald-400/15 px-3 py-2.5 text-sm font-bold text-emerald-100">
                    Navigate
                  </button>
                  <button onClick={() => openCustomerDrawer(customer, null)} className="rounded-xl border border-purple-300/20 bg-purple-400/15 px-3 py-2.5 text-sm font-bold text-purple-100">
                    Open
                  </button>
                </div>
              </article>
            ...
            {openCustomer ? (
              <div>
                <div className="mb-4 flex items-start justify-between gap-3">
                  ...
                  <button
                      onClick={closeDrawer}
                      className="mb-2 rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[11px] font-black uppercase tracking-[0.14em] text-white/45 hover:border-emerald-300/30 hover:text-emerald-100"
                      type="button"
                    >
                      Close
                    </button>
