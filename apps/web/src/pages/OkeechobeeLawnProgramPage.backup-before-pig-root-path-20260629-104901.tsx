...
function GreenPigIcon() {
  return (
    <span
      className="inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-green-400/30 bg-green-400/10 text-green-300 shadow-[0_0_28px_rgba(74,222,128,0.28)]"
      aria-hidden="true"
    >
      <svg
        viewBox="0 0 64 64"
      ...
      >
        <path d="M20 17l6 7" />
        <path d="M44 17l-6 7" />
        <path d="M18 31c0-10 6-17 14-17s14 7 14 17-6 17-14 17-14-7-14-17Z" />
        <ellipse cx="32" cy="37" rx="8.5" ry="6.5" />
        <circle cx="29" cy="37" r="1.2" fill="currentColor" stroke="none" />
        <circle cx="35" cy="37" r="1.2" fill="currentColor" stroke="none" />
        <circle cx="27" cy="28" r="1.4" fill="currentColor" stroke="none" />
