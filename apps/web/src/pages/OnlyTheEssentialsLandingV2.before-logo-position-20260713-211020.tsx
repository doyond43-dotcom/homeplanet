          ...
          <header className="flex items-center justify-between gap-4">
            <div className="flex items-center">
              <img
                ...
                className="block h-28 w-64 shrink-0 origin-left scale-[1.4] object-contain drop-shadow-[0_0_22px_rgba(244,114,182,0.48)] sm:h-32 sm:w-72 sm:scale-[1.45]"
              />
            </div>
          ...
          <div className="mt-6 grid gap-3 lg:grid-cols-3">
            ...
            <div className="grid gap-3 rounded-2xl border border-dashed border-pink-300/30 bg-black/30 p-4 text-sm text-zinc-300 lg:col-span-3 lg:grid-cols-3">
              <label className="block">
                ...
                <p className="mb-3 text-xs leading-5 text-zinc-400">Optional Ã¢â‚¬â€ show problem areas, rooms, pets, or mess level.</p>
            ...
            <div className="mt-10 grid gap-5 lg:grid-cols-2">
              <article className="flex h-full flex-col rounded-[1.75rem] border border-white/10 bg-black/25 p-6 shadow-xl shadow-black/20 transition duration-300 hover:-translate-y-1 hover:border-pink-300/25 sm:p-8">
                ...
                <blockquote className="mt-6 flex-1 font-serif text-2xl italic leading-9 text-white sm:text-[1.7rem]">
                  Ã¢â‚¬Å“Highly recommend! Kaitlyn did a great job helping us get back on
              ...
              <article className="flex h-full flex-col rounded-[1.75rem] border border-white/10 bg-black/25 p-6 shadow-xl shadow-black/20 transition duration-300 hover:-translate-y-1 hover:border-pink-300/25 sm:p-8">
                ...
                <blockquote className="mt-6 flex-1 font-serif text-2xl italic leading-9 text-white sm:text-[1.7rem]">
                  Ã¢â‚¬Å“I came home to super clean floors, sparkling bathrooms, beds made,
                  sinks cleaned... Everything back in order! Highly recommend.Ã¢â‚¬Â
                </blockquote>
