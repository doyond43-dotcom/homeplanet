...
export default function LivePagesHub() {
  ...
  const mark: CSSProperties = {
    ...
    flex: "0 0 auto",
    filter:
      "drop-shadow(0 0 16px rgba(56,189,248,0.22)) drop-shadow(0 0 12px rgba(52,211,153,0.10))",
  };
      ...
      <div style={wrap}>
        <nav style={nav}>
          <Link to="/planet/live-pages" style={brand}>
            <img
              src="/images/homeplanet_live_pages_planet_mark_TRANSPARENT.png"
              alt="HomePlanet planet mark"
              style={mark}
            />
