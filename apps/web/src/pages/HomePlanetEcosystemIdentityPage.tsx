          ...
          <div className="mt-14 grid gap-8 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="rounded-[2rem] border border-stone-700/70 bg-[#15130d] p-8">
              ...
              <h2 className="mt-4 text-4xl font-semibold">
                Each anchor serves a different role.
              </h2>
              <div className="mt-6 space-y-3 text-lg leading-8 text-stone-300">
                <p><span className="font-semibold text-white">GreenBasket</span> wakes the ecosystem up.</p>
                <p><span className="font-semibold text-white">WingIt</span> creates community energy.</p>
                <p><span className="font-semibold text-white">Delaney&apos;s Gym</span> supports participation and wellness.</p>
                <p><span className="font-semibold text-white">Garrett&apos;s Laundromat</span> keeps daily operations moving.</p>
                <p><span className="font-semibold text-white">Commons Coffee</span> creates gathering space.</p>
                <p><span className="font-semibold text-white">The Hub</span> quietly keeps everything connected.</p>
              </div>
            </div>
