...
export default function OperationalJobWorkspaceV2() {
  ...
  const [toolTab, setToolTab] = useState("customer");
  ...
  return (
    <main style={page}>
      <div style={wrap}>
        ...
        <section style={card}>
          <h2 style={sectionTitle}>Job Status</h2>

          <div style={currentStage}>
            <div style={stageLabel}>Current Status</div>
        ...
        <section style={card}>
          ...
          {toolTab === "payment" && (
            <>
              ...
              <p style={price}>{job.amount}</p>
              <button style={green}>Generate Payment</button>
...
const nextButton: React.CSSProperties = { width: "100%", border: 0, borderRadius: 18, background: "#4ade80", color: "#07111a", padding: 24, fontWeight: 900, fontSize: 24, cursor: "pointer" };
