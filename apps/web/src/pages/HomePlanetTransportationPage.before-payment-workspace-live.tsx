...
export default function HomePlanetTransportationPage() {
  ...
  <div className="mt-4 grid gap-3">
    <button onClick={() => updateStatus(selectedRide.id, "Collect Payment")} className="rounded-3xl border border-white/10 bg-black/40 p-5 text-left">
    ...
    <button onClick={() => updateStatus(selectedRide.id, "Collect Payment")} className="rounded-3xl border border-emerald-400/40 bg-emerald-400/10 p-5 text-left">
      <div className="text-lg font-black text-emerald-100">SHOW QR CODE</div>
  ...
  <div className="mt-4 rounded-3xl border border-white/10 bg-black/50 p-4 text-center">
    ...
    <p className="mt-3 text-sm text-zinc-300">
      Rider can scan this, use the payment link, tap to pay, or pay cash.
    </p>
  </div>
