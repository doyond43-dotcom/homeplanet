...
const STORAGE_KEY = "hp-restaurant-awareness-drinks";
  ...
  return (
    <article className={`rounded-3xl border p-5 ${tableClass(group)}`}>
      ...
      {!isOpen && (
        ...
        >
          {group.stage === "New" ? "START DRINKS" : group.stage === "Cooking" ? "DRINKS READY" : "PICKED UP"}
        </button>
      )}
    </article>
  );
...
export default function RestaurantAwarenessDrinkBoard() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("restaurant-awareness-drinks-sync", syncKitchenTickets);

    return () => {
      window.removeEventListener("storage", syncKitchenTickets);
      window.removeEventListener("restaurant-awareness-drinks-sync", syncKitchenTickets);
    };
  }, []);
    ...
    <main className="min-h-screen bg-neutral-950 px-4 py-5 text-white">
      <section className="mx-auto max-w-7xl space-y-5">
          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div>
              <p className="text-xs font-bold uppercase tracking-[0.3em] text-emerald-300">
                Restaurant Awareness Bar
              </p>

              <h1 className="mt-2 text-4xl font-black">Drink Awareness Board</h1>
        ...
        <section className="rounded-3xl border border-white/10 bg-neutral-900 p-5">
          ...
          <h2 className="mt-1 text-2xl font-black">What the bar is preparing right now</h2>
        ...
        <section className="rounded-3xl border border-amber-300/30 bg-amber-300/10 p-5">
          <div className="flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h2 className="text-3xl font-black">Make these drinks first</h2>
            </div>
        ...
        <section className="grid gap-5 lg:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-neutral-900 p-5">
            ...
            <h2 className="mt-1 text-3xl font-black">Drinks being made</h2>
          ...
          <div className="rounded-3xl border border-emerald-400/30 bg-emerald-400/10 p-5">
            ...
            <h2 className="mt-1 text-3xl font-black">Ready drink orders</h2>
