      ...
      <section className="relative overflow-hidden border-b border-white/10 bg-[#0D0D0D]">
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          ...
          <div className="absolute inset-y-0 right-0 w-full lg:w-[59%]">
            <img
              src="/images/vz-lawncare-eric-trimming-hero.jpeg"
              alt=""
              aria-hidden="true"
          ...
          <div className="absolute inset-0 bg-[linear-gradient(90deg,#0D0D0D_0%,#0D0D0D_34%,rgba(13,13,13,0.97)_44%,rgba(13,13,13,0.72)_58%,rgba(13,13,13,0.22)_82%,rgba(13,13,13,0.08)_100%)]" />

          <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(13,13,13,0.10)_0%,rgba(13,13,13,0.02)_58%,rgba(13,13,13,0.48)_100%)]" />

          <div className="absolute inset-0 bg-[radial-gradient(circle_at_76%_48%,rgba(8,127,35,0.10),transparent_46%)]" />
        </div>
