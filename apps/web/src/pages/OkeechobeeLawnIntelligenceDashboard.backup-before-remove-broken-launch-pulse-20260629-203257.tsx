      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mt-8 rounded-3xl border border-green-400/20 bg-green-400/[0.06] p-6 md:p-8">
          <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-black tracking-tight">
                Today&apos;s Launch Pulse
              </h2>
              <p className="mt-3 max-w-2xl text-sm font-semibold leading-relaxed text-white/60">
                Built yesterday. Launched today. These are the real signals coming in from the lawn program.
              </p>
            </div>
          ...
          <div className="mt-6 grid gap-3 md:grid-cols-5">
            {[
              ["Requests Submitted", submittedRequests.toString()],
              ["People Wanting To Help", helperInterest.toString()],
              ["Worker Interest", workerInterest.toString()],
              ["Sponsor Interest", sponsorInterest.toString()],
              ["Route Candidates", requestSummaries.length.toString()],
            ].map(([label, value]) => (
              <div
                key={label}
