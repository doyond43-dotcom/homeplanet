  ...
  return (
    <main className="min-h-screen bg-neutral-950 text-white">
      <section className="mx-auto flex min-h-screen w-full max-w-6xl flex-col px-5 py-6">
        <header className="flex items-center justify-between rounded-3xl border border-white/10 bg-white/[0.03] px-4 py-3">
        ...
        <div className="grid flex-1 items-center gap-10 py-12 lg:grid-cols-[1.05fr_.95fr]">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <a
                href="#philosophy"
                className="inline-flex items-center justify-center gap-2 rounded-2xl border border-white/12 bg-white/[0.04] px-6 py-4 text-sm font-black text-white"
              >
          ...
          <div className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-4 shadow-2xl shadow-emerald-950/30">
            <div className="rounded-[1.5rem] border border-white/10 bg-neutral-950 p-5">
              <div className="mb-5 flex items-center justify-between">
                ...
                <div className="rounded-full bg-emerald-400 px-3 py-1 text-xs font-black text-neutral-950">LIVE</div>
              </div>
              ...
              <p className="mt-5 rounded-2xl bg-emerald-300/10 p-4 text-sm leading-6 text-emerald-100">
      ...
      <section id="philosophy" className="mx-auto max-w-6xl px-5 py-16">
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-2">
          {examples.map((item) => (
            <Link
              key={item.title}
              to={item.href}
              className="group rounded-3xl border border-white/10 bg-white/[0.04] p-6 transition hover:border-emerald-300/40 hover:bg-white/[0.07]"
            >
      ...
      <section className="mx-auto max-w-6xl px-5 py-20">
        <div className="rounded-[2rem] border border-emerald-300/20 bg-emerald-300/10 p-8 text-center sm:p-12">
