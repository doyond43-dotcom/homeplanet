      ...
      <footer className="border-t border-white/10 bg-black px-4 pb-20 pt-12 text-center">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
            ...
            <a
              href={`sms:${phone}`}
              className="border-orange-900/45 hover:border-orange-500/45 hover:bg-orange-950/25 hover:shadow-[0_0_20px_rgba(180,83,9,0.18)] border-orange-900/45 hover:border-orange-500/45 hover:bg-orange-950/25 hover:shadow-[0_0_20px_rgba(180,83,9,0.18)] rounded-xl border border-white/15 bg-white/[0.04] px-8 py-4 text-xs font-black uppercase tracking-[0.2em] text-white"
            >
              Text Ridgeline
            </a>
          </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 px-5 backdrop-blur-sm">
          <div className="w-full max-w-lg rounded-[2rem] border border-orange-400/25 bg-[#120b04] p-7 text-center shadow-2xl shadow-orange-950/50 sm:p-9">
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row sm:justify-center">
              <a
                href={`sms:${phone}`}
                className="border-orange-900/45 hover:border-orange-500/45 hover:bg-orange-950/25 hover:shadow-[0_0_20px_rgba(180,83,9,0.18)] border-orange-900/45 hover:border-orange-500/45 hover:bg-orange-950/25 hover:shadow-[0_0_20px_rgba(180,83,9,0.18)] inline-flex items-center justify-center gap-2 rounded-full bg-orange-500 px-6 py-3 text-xs font-black uppercase tracking-[0.22em] text-black"
              >
