...
export default function OkeechobeeCreateEventPage() {
  ...
  return (
    <main style={styles.page}>
      <section style={styles.card}>
        ...
        <h1 style={styles.title}>Create a Community Post</h1>
        <p style={styles.subtitle}>
          Share a real need, offer, opportunity, event, or alert with the community.
        </p>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <button style={styles.button} type="submit">Create Shareable Page</button>
        </form>
      </section>
    </main>
  );
