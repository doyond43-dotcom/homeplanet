...
function GreenPigIcon() {
  return (
    <span
      className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-green-400/30 bg-green-400/10 text-green-300 shadow-[0_0_28px_rgba(74,222,128,0.28)]"
      aria-hidden="true"
    >
      <svg
        viewBox="0 0 64 64"
      ...
      >
        <path d="M18 36c0-10 8-18 19-18h5c7 0 13 6 13 13v5c0 9-7 16-16 16H28c-6 0-10-4-10-10v-6Z" />
        <path d="M18 35h-6c-4 0-7-3-7-7 0-3 2-6 5-7" />
        <path d="M42 18l5-8 3 10" />
        <circle cx="42" cy="32" r="1.5" fill="currentColor" stroke="none" />
        <path d="M24 52v5M45 52v5" />
        <path d="M28 40h10" />
      </svg>
    </span>
  );
