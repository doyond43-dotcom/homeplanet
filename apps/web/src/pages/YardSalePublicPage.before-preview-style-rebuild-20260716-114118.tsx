...
export default function YardSalePublicPage() {
  ...
  const shareSale = async () => {
    ...
    const shareTitle = sale?.sale_name || "Yard Sale";
  ...
  return (
    <main className="ysp-page">
      ...
      <footer className="ysp-footer">
        <div className="ysp-footer-copy">
          <span>Built after seeing the value</span>
          <strong>Selling your own stuff soon?</strong>
          <p>
            Build one clean yard sale page, add your best items, and share one
            link everywhere.
          </p>
        </div>

        <div className="ysp-footer-actions">
        ...
        <small>Powered by HomePlanet</small>
      </footer>
        ...
        * {
        ...
        .ysp-footer {
          ...
          background:
            ...
            rgba(89, 255, 145, 0.035);
        }

        .ysp-footer-copy > span {
          display: block;
          margin-bottom: 8px;
          color: #59ff91;
          font-size: 9px;
        ...
        .ysp-footer-actions a,
        .ysp-footer-actions button,
        .ysp-state a {
          min-height: 48px;
          display: inline-flex;
          align-items: center;
