...
export default function LivePagesHub() {
  ...
  const mark: CSSProperties = {
    ...
    objectFit: "contain",
    filter:
      "drop-shadow(0 0 16px rgba(56,189,248,0.18)) drop-shadow(0 0 12px rgba(52,211,153,0.08))",
  };
      ...
      <div style={wrap}>
        <nav style={nav}>
          <Link to="/planet/live-pages" style={brand}>
            <img
              src="/images/a_clean_logo_branding_graphic_on_a_transparent_che_1.png"
