  ...
  return (
    <main className="min-h-screen bg-[#07090d] text-white">
      ...
      <style>{`
        ...
        .jme-door:first-child::before {
          background-image:
            url("/images/jme-shop-rental-yard.jpg");
        }
      ...
      `}</style>
            ...
            <div className="jme-door-grid">
              ...
              >
                <div>
                  ...
                  <p>
                    Tell JME what equipment you need, the job you are handling,
                    and your requested rental dates.
                  </p>
                </div>
              ...
              >
                <div>
                  ...
                  <p>
                    Tell JME what machine is down, what it is doing, and where
        ...
        <footer className="jme-footer">
          <div className="jme-shell jme-footer-inner">
            <span>
              Jones Equipment Rental &amp; Repair Ãƒâ€šÃ‚Â· {formattedPhone}
            </span>
