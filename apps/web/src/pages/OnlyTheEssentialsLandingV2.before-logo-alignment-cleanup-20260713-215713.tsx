      ...
      <section className="relative border-b border-pink-300/10">
        ...
        <div className="relative mx-auto max-w-7xl px-5 py-8 sm:px-8 lg:px-12">
          <header className="flex items-center justify-between gap-4">
            <div className="relative h-36 w-[26rem] shrink-0 sm:h-40 sm:w-[30rem]">
              <img
                src="/images/only-the-essentials-cleaning-premium-logo.png"
                alt="Only The Essentials Cleaning"
                className="absolute left-0 -top-1 h-auto w-[22rem] max-w-none object-contain drop-shadow-[0_0_24px_rgba(244,114,182,0.52)] sm:left-2 sm:top-0 sm:w-[25rem]"
              />
            </div>
          ...
          <div className="mt-6 grid gap-3 lg:grid-cols-3">
            ...
            <div className="grid gap-3 rounded-2xl border border-dashed border-pink-300/30 bg-black/30 p-4 text-sm text-zinc-300 lg:col-span-3 lg:grid-cols-3">
              <label className="block">
                ...
                <p className="mb-3 text-xs leading-5 text-zinc-400">Optional ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â show problem areas, rooms, pets, or mess level.</p>
          ...
          <div className="relative">
            ...
            <div className="mt-10 grid gap-5 lg:grid-cols-2">
              <article className="flex h-full flex-col rounded-[1.75rem] border border-white/10 bg-black/25 p-6 shadow-xl shadow-black/20 transition duration-300 hover:-translate-y-1 hover:border-pink-300/25 sm:p-8">
                ...
                >
                  ÃƒÆ’Ã‚Â¢Ãƒâ€¹Ã…â€œÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ÃƒÆ’Ã‚Â¢Ãƒâ€¹Ã…â€œÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ÃƒÆ’Ã‚Â¢Ãƒâ€¹Ã…â€œÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ÃƒÆ’Ã‚Â¢Ãƒâ€¹Ã…â€œÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦ÃƒÆ’Ã‚Â¢Ãƒâ€¹Ã…â€œÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¦
                </p>

                <blockquote className="mt-6 flex-1 font-serif text-2xl italic leading-9 text-white sm:text-[1.7rem]">
                  ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã¢â‚¬Å“Highly recommend! Kaitlyn did a great job helping us get back on
                  track. From the ceiling to the floor she knocked it out of the
                  park!ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â
                </blockquote>
              ...
              <article className="flex h-full flex-col rounded-[1.75rem] border border-white/10 bg-black/25 p-6 shadow-xl shadow-black/20 transition duration-300 hover:-translate-y-1 hover:border-pink-300/25 sm:p-8">
                ...
                <blockquote className="mt-6 flex-1 font-serif text-2xl italic leading-9 text-white sm:text-[1.7rem]">
                  ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã¢â‚¬Å“I came home to super clean floors, sparkling bathrooms, beds made,
                  sinks cleaned... Everything back in order! Highly recommend.ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â
                </blockquote>
