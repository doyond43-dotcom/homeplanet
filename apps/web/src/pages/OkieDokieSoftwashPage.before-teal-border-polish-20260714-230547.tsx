  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#030807] text-white">
      ...
      <div className="relative mx-auto w-full max-w-[1120px] px-5 pb-16 pt-8 sm:px-8 lg:px-10 lg:pt-10">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            {services.map(({ name, copy, icon: Icon }) => (
              <button
                ...
                className="group rounded-[1.5rem] border border-[rgba(52,211,153,0.18)] bg-white/[0.035] p-6 text-left transition hover:-translate-y-1 hover:border-[rgba(52,211,153,0.7)] hover:bg-emerald-400/[0.055] hover:shadow-[0_0_32px_rgba(16,185,129,0.09)]"
              >
        ...
        {/* WORKFLOW / TRUST */}
        <section className="mt-16 rounded-[2rem] border border-emerald-400/28 bg-[linear-gradient(135deg,rgba(5,17,13,0.98),rgba(1,7,5,0.98))] p-6 sm:p-8 lg:p-10">
          <div className="grid gap-8 lg:grid-cols-[0.82fr_1.18fr]">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {[
                ...
                <div
                  key={title}
                  className="rounded-[1.5rem] border border-emerald-400/15 bg-black/35 p-5"
                >
        ...
        <section
          id="estimate"
          className="mt-16 rounded-[2rem] border border-emerald-400/35 bg-[linear-gradient(135deg,rgba(5,15,12,0.98),rgba(0,6,4,0.98))] p-6 shadow-[0_0_50px_rgba(16,185,129,0.05)] sm:p-8"
        >
            ...
            <div>
              ...
              <div className="mt-7 space-y-3">
                {[
                  ...
                  <div
                    key={step}
                    className="flex items-center gap-4 rounded-2xl border border-emerald-400/14 bg-black/35 px-4 py-4"
                  >
