...
const entries: TranslationEntry[] = [
  ...
  ["Cow Town Recovery Overlay", "Mejora con Calcoman\u00eda Cow Town", "Mise \u00e0 Niveau avec Autocollant Cow Town"],
  ["A durable recovery overlay applied directly to the livestock ear tag the animal already wears. The ranch keeps its existing animal number and numbering system, while the overlay adds a unique Cow Town recovery ID, a scannable QR, and the clear instruction \u201cFOUND? SCAN ME.\u201d", "Una calcoman\u00eda QR duradera aplicada directamente a la etiqueta que el animal ya usa. El rancho conserva su n\u00famero y sistema existentes, mientras la calcoman\u00eda agrega un ID \u00fanico de recuperaci\u00f3n Cow Town y la instrucci\u00f3n clara \u201cESCANEAR PARA CONTACTAR AL RANCHO\u201d.", "Un autocollant QR durable appliqu\u00e9 directement sur l\u2019\u00e9tiquette d\u00e9j\u00e0 port\u00e9e. La ferme conserve son num\u00e9ro et son syst\u00e8me existants, tandis que l\u2019autocollant ajoute un identifiant Cow Town unique et l\u2019instruction claire \u00ab SCANNER POUR JOINDRE LA FERME \u00bb."],
  ...
  ["Clearly labeled \u201cFOUND? SCAN ME\u201d", "Claramente marcado \u201cESCANEAR PARA EL RANCHO\u201d", "Clairement indiqu\u00e9 \u00ab SCANNER POUR LA FERME \u00bb"],
  ["Waterproof and UV-resistant recovery overlay", "Calcoman\u00eda QR impermeable y resistente a rayos UV", "Autocollant QR imperm\u00e9able et r\u00e9sistant aux UV"],
  ["Each overlay opens that animal\u2019s live recovery page", "Cada calcoman\u00eda abre la p\u00e1gina activa de recuperaci\u00f3n de ese animal", "Chaque autocollant ouvre la page active de r\u00e9cup\u00e9ration de cet animal"],
