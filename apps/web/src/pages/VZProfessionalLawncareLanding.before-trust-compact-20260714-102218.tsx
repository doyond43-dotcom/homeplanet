      ...
      >
        <div className="mx-auto max-w-[1380px] px-5 py-20 sm:px-8 lg:px-10 lg:py-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2
              id="vz-trust-heading"
              className="mt-4 text-4xl font-black leading-[0.94] tracking-[-0.045em] text-white sm:text-5xl"
            >
              Real words from
          ...
          <div className="mt-12 grid gap-5 lg:grid-cols-2">
            <article className="flex h-full flex-col rounded-[1.75rem] border border-[#087F23]/35 bg-[#0D0D0D]/80 p-6 shadow-2xl shadow-black/30 ring-1 ring-[#7CFC00]/[0.06] transition duration-300 hover:-translate-y-1 hover:border-[#FFD000]/35 sm:p-8">
              <p
                aria-label="Five-star customer recommendation"
                className="text-3xl tracking-[0.12em] text-[#FFD000]"
              >
                ★★★★★
              </p>

              <blockquote className="mt-6 flex-1 text-xl font-bold leading-8 text-white sm:text-2xl sm:leading-9">
              ...
              <div className="mt-8 border-t border-[#087F23]/35 pt-5">
