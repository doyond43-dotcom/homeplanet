          ...
          <header className="flex items-center justify-between gap-4">
            <div className="flex items-center">
              <img
                ...
                className="h-24 w-24 rounded-[1.35rem] border border-pink-300/30 bg-white/[0.04] p-2 object-contain shadow-[0_0_28px_rgba(236,72,153,0.28)] backdrop-blur-sm sm:h-28 sm:w-28"
              />
            </div>
