...
<div style={{ maxWidth: 1100, margin: "0 auto" }}>
  ...
  <div style={{ padding: "28px 0", borderTop: "1px solid #1f2937", borderBottom: "1px solid #1f2937" }}>
    <div style={{ fontSize: 30, fontWeight: 700, marginBottom: 8 }}>
      YOUTH SPORTS SPONSORSHIP
    </div>
    <div style={{ color: "#94a3b8" }}>
      Supporting local athletes and families.
    </div>
  </div>

  <div style={{ padding: "28px 0", borderBottom: "1px solid #1f2937" }}>
    <div style={{ fontSize: 30, fontWeight: 700, marginBottom: 8 }}>
      HOLIDAY FOOD DRIVE
    </div>
    <div style={{ color: "#94a3b8" }}>
      Helping local families throughout the community.
    </div>
  </div>

  <div style={{ padding: "28px 0", borderBottom: "1px solid #1f2937" }}>
    <div style={{ fontSize: 30, fontWeight: 700, marginBottom: 8 }}>
      ACREAGE COMMUNITY EVENT
    </div>
    <div style={{ color: "#94a3b8" }}>
  ...
  <div style={{ padding: "28px 0", borderBottom: "1px solid #1f2937" }}>
    ...
    <div style={{ color: "#94a3b8" }}>
      Working alongside local businesses throughout Palm Beach County.
    </div>
  </div>
