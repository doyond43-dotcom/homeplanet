...
function smsBody(phone: string, body: string) {
  return phone ? `sms:${phone}?&body=${encodeURIComponent(body)}` : "#";
}
...
function buildEstimateText(signal: Signal) {
  return `Hi ${signal.name}, this is Ridgeline Pro Wash. We reviewed your ${signal.service} request at ${signal.address}. Based on the details sent over, the next step is to confirm the scope/photos and send your estimate. Preferred time: ${signal.preferred}.`;
}
            ...
            <div className="mt-6 space-y-3">
              ...
              <div className="rounded-2xl border border-white/10 bg-zinc-950 p-4">
                ...
                <a
                  ...
                  className="mt-4 block w-full rounded-xl bg-emerald-400 py-3 text-center text-sm font-black text-black shadow-[0_0_30px_rgba(52,211,153,0.15)]"
                >
              ...
              <div className="rounded-2xl border border-emerald-300/25 bg-emerald-400/10 p-4 shadow-[0_0_35px_rgba(52,211,153,0.08)]">
                <p className="flex items-center gap-2 text-xs font-black uppercase tracking-[0.25em] text-emerald-200">
                  <CreditCard size={15} />
                  Payment
                </p>
                ...
                <a
                  ...
                  className="mt-4 block rounded-xl bg-emerald-300 py-3 text-center text-xs font-black uppercase text-black"
                >
                  Send Payment Link Text
                </a>
              </div>

              <div className="rounded-2xl border border-pink-300/25 bg-pink-400/10 p-4 shadow-[0_0_35px_rgba(244,114,182,0.08)]">
                <p className="flex items-center gap-2 text-xs font-black uppercase tracking-[0.25em] text-pink-200">
                  <Star size={15} />
                  Review / Share
                </p>
                ...
                <div className="mt-4 grid grid-cols-2 gap-2">
                  <a
                    ...
                    className="rounded-xl bg-pink-300 py-3 text-center text-xs font-black uppercase text-black"
                  >
                    Send Review Text
                  </a>
                  ...
                  <button
                    type="button"
                    onClick={() => copyToClipboard(buildSocialPost(selected))}
                    className="rounded-xl border border-pink-300/30 bg-pink-300/10 py-3 text-xs font-black uppercase text-pink-100"
                  >
