...
const ecosystemSteps = [
  {
    ...
    detail: "A real need appears.",
  },
  {
    label: "Conversation",
    title: "Can you come today?",
    detail: "The relationship starts.",
  },
  {
    label: "Request",
    title: "Photos attached.",
    detail: "The details stay connected.",
  },
  {
    label: "Workspace",
    title: "Estimate waiting.",
    detail: "The request becomes work.",
  },
  {
    label: "Completed",
    title: "Payment received.",
    detail: "The outcome is recorded.",
  },
  {
    label: "Proof",
    title: "Before and after.",
    detail: "The work speaks for itself.",
  },
];
...
export default function CreatorCity() {
  ...
  const contact = () => {
    window.location.href =
      "mailto:dannyscandys@gmail.com?subject=Build%20My%20HomePlanet%20System";
  };
    ...
    <main className="creator-city">
      <style>{`
        * {
        ...
        @media (max-width: 1000px) {
          ...
          .cc-ecosystem-step:nth-child(2n) {
            border-right: 0;
          }
      ...
      <div className="cc-shell">
        <header className="cc-topbar">
          ...
          <button className="cc-button" onClick={contact}>
            Build My System
          </button>
        </header>

        <section className="cc-hero">
          <div className="cc-kicker">Business infrastructure for real life</div>
          ...
          <p className="cc-hero-copy">
            ...
            <br />
            <strong>A working system for everything that happens next.</strong>
          </p>
          ...
          <div className="cc-hero-note">
            No disconnected forms. No scattered work.
          </div>
        </section>
      ...
      <section className="cc-final">
        <div className="cc-shell">
          <h2>
            ...
            <br />
            <span>Run everything that happens underneath.</span>
          </h2>

          <p>
            Start with what you need now. Grow the system around the real way
            your business, customers, and community already work.
          </p>
