      ...
      <section className="mx-auto max-w-xl">
        ...
        <div className="rounded-3xl border border-white/10 bg-white/[0.03] p-6">
          ...
          <div className="mt-6 space-y-4">
            ...
            <select value={serviceType} onChange={(e) => setServiceType(e.target.value)} className="w-full rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-4 outline-none focus:border-rose-300/40">
...
<div className="grid grid-cols-2 gap-3">
  <input value={bedrooms} onChange={(e) => setBedrooms(e.target.value)} placeholder="Bedrooms" className="rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-4 outline-none focus:border-rose-300/40" />
  <input value={bathrooms} onChange={(e) => setBathrooms(e.target.value)} placeholder="Bathrooms" className="rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-4 outline-none focus:border-rose-300/40" />
</div>

<select value={condition} onChange={(e) => setCondition(e.target.value)} className="w-full rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-4 outline-none focus:border-rose-300/40">
  <option value="">Current Condition</option>
  <option>Light Maintenance</option>
  <option>Average</option>
  <option>Needs Extra Attention</option>
  <option>Heavy Deep Clean</option>
</select>

<select value={pets} onChange={(e) => setPets(e.target.value)} className="w-full rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-4 outline-none focus:border-rose-300/40">
...
<div className="rounded-2xl border border-rose-300/20 bg-rose-400/10 p-4 text-sm">
