...
export default function LivePagesHub() {
  ...
  const brandSub: CSSProperties = {
    ...
    color: "#1ea7ff",
    whiteSpace: "nowrap",
    textShadow: "0 0 14px rgba(56,189,248,0.34)",
  };
          ...
          <div style={visualGrid}>
            <div
              style={{
                ...
                border: "1px solid rgba(255,255,255,0.10)",
                background:
                  "linear-gradient(135deg, rgba(2,6,23,0.82), rgba(3,21,15,0.78)), radial-gradient(circle at 18% 18%, rgba(52,211,153,0.18), transparent 32%), radial-gradient(circle at 82% 28%, rgba(14,165,233,0.15), transparent 34%)",
                padding: "clamp(18px, 3vw, 28px)",
                boxShadow:
                  "0 24px 70px rgba(0,0,0,0.32), inset 0 1px 0 rgba(255,255,255,0.06)",
              }}
            >
              <div
                style={{
              ...
              >
                ...
                >
                  ...
                  <h3 style={{ margin: 0, fontSize: 34, lineHeight: 0.96, letterSpacing: "-0.05em" }}>
                    The customer knows where to start.
                  </h3>
                  <p style={{ ...sub, fontSize: 13, marginTop: 10 }}>
                    Request service, upload photos, and explain what they need without getting buried in comments.
                  </p>

                  <div style={{ ...screenCard, marginTop: 16 }}>
                  ...
                  <div style={{ ...primary, display: "block", textAlign: "center", marginTop: 14 }}>
                    Start request
                  </div>
                </div>
                ...
                >
                  ...
                  <p style={{ ...sub, fontSize: 13, marginTop: 10 }}>
                    Every request becomes something you can review, price, schedule, update, or close.
                  </p>
                  ...
                  >
                    {[
                      ["01", "Message received", "Customer request lands."],
                      ["02", "Ready to review", "Photos and notes stay together."],
                      ["03", "Next step", "Estimate, book, update, or collect payment."],
                    ].map(([num, title, body]) => (
                      <div key={title} style={columnCard}>
                        <div style={{ color: "#34d399", fontSize: 12, fontWeight: 950 }}>{num}</div>
                        <strong style={{ display: "block", marginTop: 8 }}>{title}</strong>
                        <p style={{ ...sub, marginTop: 6, fontSize: 12 }}>{body}</p>
                      </div>
                    ))}
                  </div>
                </div>
