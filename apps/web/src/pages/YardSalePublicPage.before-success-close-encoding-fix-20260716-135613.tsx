        ...
        <div className="ys-public-items-grid">
          {featuredItems.map((item, index) => {
            ...
            return (
              ...
              >
                <div
                  className="ys-public-item-photo"
                  style={{
                    backgroundImage: `
                      linear-gradient(
                        180deg,
                ...
                <div className="ys-public-item-body">
      ...
      {contactItemName !== null && (
        ...
        >
          ...
          >
            ...
            <button
              type="button"
              className="ys-contact-copy"
              onClick={copyContactMessage}
            >
              {contactCopied ? "Message Copied" : "Copy Message"}
            </button>

            <div className="ys-contact-method">
      ...
      <style>{`
        ...
        * {
        ...
        .ys-public-item-card:hover {
          ...
          border-color: rgba(89, 255, 145, 0.28);
          background: rgba(89, 255, 145, 0.045);
        }

        .ys-public-item-photo {
          display: flex;
