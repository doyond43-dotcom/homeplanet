    ...
    <main className="min-h-screen bg-[#050607] text-white">
      <section className="mx-auto max-w-7xl px-5 py-6">
        <header className="flex items-center justify-between rounded-3xl border border-white/10 bg-white/[0.035] px-4 py-3 backdrop-blur-xl">
          ...
          <Link to="/planet/restaurant-build" className="rounded-full bg-white px-4 py-2 text-xs font-black text-black">Build</Link>
        </header>
        ...
        <div className="grid items-center gap-10 py-16 lg:grid-cols-[1fr_.9fr]">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link to="/planet/restaurant-build" className="inline-flex items-center justify-center gap-2 rounded-2xl bg-emerald-400 px-6 py-4 text-sm font-black text-black shadow-xl shadow-emerald-500/20">Build My Restaurant <ArrowRight size={18} /></Link>
      ...
      <section className="mx-auto max-w-7xl px-5 py-16">
        <div className="rounded-[2.5rem] border border-emerald-300/20 bg-emerald-300/10 p-8 text-center sm:p-12">
          ...
          <Link to="/planet/restaurant-build" className="mt-8 inline-flex items-center justify-center gap-2 rounded-2xl bg-emerald-400 px-6 py-4 text-sm font-black text-black">Build My Restaurant <ArrowRight size={18} /></Link>
        </div>
      </section>
    </main>
  );
