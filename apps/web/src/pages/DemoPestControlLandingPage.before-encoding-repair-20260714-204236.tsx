      ...
      <div className="relative mx-auto w-full max-w-[1120px] px-5 pb-16 pt-8 sm:px-8 lg:px-10 lg:pt-10">
        ...
        <section className="mt-16">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            {pestOptions.map(({ name, copy, icon: Icon }) => (
              <button
                ...
                className="group rounded-[1.5rem] border border-[#80df00]/18 bg-white/[0.035] p-6 text-left transition hover:-translate-y-1 hover:border-[#80df00]/68 hover:bg-[#80df00]/[0.055] hover:shadow-[0_0_32px_rgba(126,224,0,0.08)]"
              >
          ...
          <button
            ...
            className="mt-4 flex w-full items-center justify-between gap-5 rounded-[1.5rem] border border-[#80df00]/28 bg-white/[0.025] px-6 py-5 text-left transition hover:border-[#80df00]/72 hover:bg-[#80df00]/[0.05] hover:shadow-[0_0_28px_rgba(126,224,0,0.07)]"
          >
        ...
        <section className="mt-16">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            {reviews.map((review) => (
              <article
                key={review.name}
                className="rounded-[1.5rem] border border-[#80df00]/14 bg-white/[0.035] p-6 transition hover:border-[#80df00]/42 hover:bg-[#80df00]/[0.028]"
              >
