                  ...
                  >
                    ...
                    <div className="mt-4 flex flex-wrap gap-2">
                      <button
                        ...
                        className="rounded-2xl border border-green-500/30 bg-green-500/10 px-4 py-2 text-xs font-black uppercase tracking-[0.18em] text-green-400 transition hover:bg-green-500/20"
                      >
                        OPEN WORKSPACE
                      </button>
