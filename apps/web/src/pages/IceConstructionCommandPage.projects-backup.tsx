  ...
  return (
    <main style={styles.page}>
      ...
      <section style={styles.grid}>
        <ProjectCard status="ON TRACK" title="Palm Beach Waterfront Remodel" progress="75%" crew="Mike - Tony - Carlos" note="Last update: 18 minutes ago" />
        <ProjectCard status="WAITING ON MATERIALS" title="Oceanfront Condo Renovation" progress="42%" crew="Chris - David" note="Cabinet delivery pending" />
        <ProjectCard status="NEEDS ATTENTION" title="Rental Property #12" progress="61%" crew="Crew Bravo" note="Customer waiting on update" />
      </section>
        ...
        <div style={styles.overlay}>
          <div style={styles.modal}>
            ...
            <p style={styles.muted}>
              Share a tool, shortcut, product, custom build, process, or idea that could make the work easier.
            </p>
            ...
            <button style={styles.primary} onClick={() => setShareOpen(false)}>
              Send Idea
            </button>

            <p style={styles.small}>
              Demo mode: this button closes the panel for now. Next step is connecting it to HomePlanet messages.
            </p>
          </div>
        </div>
      )}
...
const styles: Record<string, React.CSSProperties> = {
  ...
  small: { color: "#78848d", fontSize: 12, textAlign: "center", marginTop: 14 },
};
