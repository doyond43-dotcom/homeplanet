              ...
              <div className="grid gap-4 xl:grid-cols-[1.25fr_0.75fr]">
                <article className="rounded-[1.75rem] border border-white/10 bg-black/35 p-5 sm:p-6">
                  ...
                  <p className="mt-4 text-sm leading-6 text-white/58">
                    This is where the actual job starts to feel real. In a live
                    system, before photos, after photos, completion notes, and
                    customer confirmation stay attached to the same request.
                  </p>

                  <div className="mt-5 grid gap-4 sm:grid-cols-2">
                    <div className="overflow-hidden rounded-[1.5rem] border border-white/10 bg-[#050a07]">
                      <div className="relative aspect-[4/3] overflow-hidden">
                        <img
                          src="/images/okee-dokie-home-services-hero.png"
                          alt="Demo before service photo"
                          loading="lazy"
                          decoding="async"
                          className="h-full w-full object-cover object-[18%_center]"
                        />

                        <div className="absolute inset-0 bg-[linear-gradient(to_top,rgba(0,0,0,0.82)_0%,rgba(0,0,0,0.16)_52%,transparent_100%)]" />
                        ...
                        <div className="absolute inset-x-0 bottom-0 p-4">
                          ...
                          <p className="mt-1 text-sm font-bold text-white/88">
                            Arrival / condition documented
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="border-t border-white/10 px-4 py-3">
                        <p className="text-xs leading-5 text-white/52">
                          Demo proof tile. Swap this image later with a real
                          before photo if desired.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="overflow-hidden rounded-[1.5rem] border border-white/10 bg-[#050a07]">
                      <div className="relative aspect-[4/3] overflow-hidden">
                        ...
                        <div className="absolute inset-x-0 bottom-0 p-4">
                          ...
                          <p className="mt-1 text-sm font-bold text-white/88">
                            Completion / final result documented
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="mt-5 grid gap-2 sm:grid-cols-2">
                    <div
                      className={`rounded-2xl border px-4 py-3 text-sm font-bold ${
                        active.status &&
                        active.status !== "New Request"
                          ? "border-[#80df00]/35 bg-[#80df00]/10 text-white"
                    ...
                    <div
                      className={`rounded-2xl border px-4 py-3 text-sm font-bold ${
                        ["Proof Added", "Follow-Up", "Completed"].includes(
                          active.status || "",
                        )
                          ? "border-[#80df00]/35 bg-[#80df00]/10 text-white"
                          : "border-white/10 bg-white/[0.03] text-white/48"
                    ...
                    <div
                      className={`rounded-2xl border px-4 py-3 text-sm font-bold ${
                        ["Completed"].includes(active.status || "")
                          ? "border-[#80df00]/35 bg-[#80df00]/10 text-white"
                          : "border-white/10 bg-white/[0.03] text-white/48"
                      }`}
                    >
                      Ready for follow-up / complete
                    </div>
                  </div>

                  <div className="mt-5 rounded-[1.5rem] border border-[#80df00]/20 bg-[#80df00]/[0.04] p-4">
                    <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[#80df00]">
                      Proof Status
                    </p>

                    <p className="mt-2 text-base font-bold text-white/84">
                      {proofStatus}
                    </p>
                    ...
                    <button
                      type="button"
                      onClick={addProof}
                      className="mt-4 w-full rounded-2xl bg-[#80df00] px-4 py-3 font-black text-black"
                    >
                ...
                <article className="rounded-[1.75rem] border border-white/10 bg-black/35 p-5">
                  ...
                  <p className="mt-4 text-sm leading-6 text-white/56">
                    After the proof is attached, the job can move naturally
                    into follow-up, customer confirmation, and completion.
                  </p>
