export default function LakeExperienceShowcasePage() {
  const catches = [
    ...
    },
    {
      ...
      image: "/images/lake-showcase-pontoon-sunset.jpg",
    },
  ];
    ...
    <main className="min-h-screen bg-[#071019] text-white">
      <section className="relative overflow-hidden border-b border-cyan-400/20">
        <div
          ...
          style={{
            backgroundImage: "url('/images/lake-showcase-hero.jpg')",
          }}
        />
        ...
        <div className="relative mx-auto flex max-w-7xl flex-col gap-8 px-6 py-24">
          ...
          <div className="flex flex-wrap gap-4">
            <a
              href="/planet/demo/lake-showcase-booking"
            ...
            <a
              href="/planet/demo/lake-showcase-privacy"
      ...
      <section className="mx-auto max-w-7xl px-6 pb-10">
        <div className="overflow-hidden rounded-[34px] border border-white/10 bg-[#0c1824]">
          <div
            ...
            style={{
              backgroundImage: "url('/images/lake-showcase-catch.jpg')",
            }}
          />
        ...
        <div className="grid gap-6 rounded-[34px] border border-emerald-400/20 bg-emerald-400/10 p-6 md:grid-cols-[0.8fr_1.2fr] md:items-center">
          <div className="rounded-[28px] border border-white/10 bg-[#071019] p-6">
            ...
            <p className="mt-4 text-sm leading-7 text-white/70">
              Guests can quickly upload trip photos from their phone and keep the experience connected in one simple memory page.
            </p>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-20">
        <div className="mb-8">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-white/65">
            Real catches, real lake moments, and memorable experiences shared by guests.
          </p>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24">
        <div className="grid gap-6 overflow-hidden rounded-[34px] border border-white/10 bg-white/[0.03] p-6 md:grid-cols-[0.8fr_1fr] md:items-center">
          <div
            ...
            style={{
              backgroundImage: "url('/images/stay-showcase-home.jpg')",
            }}
          />
          ...
          <div className="p-2 md:p-6">
            ...
            <p className="mt-4 max-w-2xl text-sm leading-7 text-white/70">
              Fishing trips, pontoon experiences, vacation stays, and lake memories can all work together in one clean customer experience.
            </p>
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-6 py-10 md:grid-cols-[1.2fr_0.8fr_0.8fr]">
          ...
          <div>
            ...
            <div className="mt-4 grid gap-3 text-sm font-bold text-white/70">
              <a href="/planet/demo/lake-showcase-booking" className="hover:text-cyan-100">Book Charter</a>
              <a href="/planet/demo/lake-showcase-memory" className="hover:text-cyan-100">Trip Memories</a>
              <a href="#guest-upload" className="hover:text-cyan-100">Upload Memories</a>
              <a href="/planet/demo/stay-showcase" className="hover:text-cyan-100">Vacation Stay</a>
            </div>
          </div>
