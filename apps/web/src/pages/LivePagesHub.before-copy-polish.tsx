      ...
      <div style={wrap}>
        ...
        <section style={strip}>
          ...
          <p style={{ color: "#94a3b8", lineHeight: 1.55, maxWidth: 820, fontSize: 17 }}>
            ...
            where things stand. We build in order, keep the workflow clear, and move each Live System
            toward review.
          </p>
          ...
          <div style={queueGrid}>
            {[
              ...
              ["03", "First version building", "Your Live Page and work board are shaped around the workflow."],
              ["04", "Ready for review", "You see the first version before paying."],
              ["05", "Approved and live", "$47/month keeps the system live and maintained."],
            ].map(([num, title, text]) => (
