          ...
          <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm leading-6 text-white/75">
                Tell Brad what youâ€™re seeing and where itâ€™s happening.
              </p>
            </div>
        ...
        <div className="mt-8 grid gap-4 lg:grid-cols-2">
          <article className="rounded-3xl border border-white/10 bg-white/[0.045] p-6 shadow-[0_0_34px_rgba(31,111,190,0.08)] sm:p-7">
            ...
            <p className="mt-5 text-sm leading-7 text-white/72">
              â€œWe work with Brad at Slap-A-Bug. He handles all our pest issues,
            ...
            <div>
              ...
              <div className="mt-6 grid gap-3">
                {[
                  ...
                  ["2", "Tell Brad where youâ€™re seeing it"],
