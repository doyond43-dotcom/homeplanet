        ...
        <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm">
          <aside className="ml-auto flex h-full w-full max-w-md flex-col border-l border-pink-300/20 bg-black p-5 shadow-2xl shadow-pink-950/40">
            ...
            <div className="mt-5 space-y-4 overflow-auto pb-6">
              ...
              <div className="rounded-2xl border border-white/10 bg-zinc-950 p-4"><p className="text-xs font-black uppercase tracking-[0.25em] text-zinc-500">ESTIMATE</p></div>

              <div className="rounded-2xl border border-white/10 bg-zinc-950 p-4"><p className="text-xs font-black uppercase tracking-[0.25em] text-zinc-500">SCHEDULE</p></div>
              ...
              <div className="rounded-2xl border border-white/10 bg-zinc-950 p-4"><p className="text-xs font-black uppercase tracking-[0.25em] text-zinc-500">PAYMENT</p></div>
