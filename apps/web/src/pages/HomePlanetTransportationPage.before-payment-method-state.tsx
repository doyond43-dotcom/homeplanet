...
export default function HomePlanetTransportationPage() {
  ...
  <div className="mt-4 grid grid-cols-2 gap-3">
    <button
      onClick={() => updateStatus(selectedRide.id, "Collect Payment")}
      className="rounded-3xl border border-white/10 bg-black/40 p-5 text-left"
    >
    ...
    <button
      onClick={() => updateStatus(selectedRide.id, "Collect Payment")}
      className="rounded-3xl border border-emerald-400/40 bg-emerald-400/10 p-5 text-left"
    >
