...
export default function LakeExperienceMemoryPage() {
  ...
  const memoryUrl =
    typeof window !== "undefined"
      ...
      : "https://www.homeplanet.city/planet/demo/lake-showcase-memory";
      ...
      <section className="mx-auto max-w-6xl">
        ...
        <div className="overflow-hidden rounded-[34px] border border-white/10 bg-[#0c1824]">
          <div
            ...
            style={{ backgroundImage: "url('/images/lake-showcase-fishing.jpg')" }}
          />
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-[0.7fr_1fr]">
          <div className="overflow-hidden rounded-[30px] border border-white/10 bg-[#0c1824]">
            <div
              ...
              style={{ backgroundImage: "url('/images/lake-showcase-catch.jpg')" }}
            />
            <div className="p-6">
