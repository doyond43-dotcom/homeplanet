      ...
      <section className="mx-auto flex min-h-screen max-w-md flex-col px-4 py-5">
        <div className="mb-4 rounded-[2rem] border border-blue-500/20 bg-white/5 p-4 shadow-2xl shadow-blue-950/40">
          ...
          <div className="mt-5 grid grid-cols-2 gap-3">
            <a href={`sms:${smsPhone}?&body=${requestBody}`} className="flex items-center justify-center rounded-2xl bg-blue-500 px-4 py-4 text-sm font-black text-white">
              Message
            </a>
        ...
        <div className="space-y-3">
          ...
          {data.paymentUrl && (
            <section className="rounded-[1.6rem] border border-blue-400/20 bg-blue-500/10 p-5">
              ...
              <p className="mt-2 text-sm leading-relaxed text-slate-200">
                {data.paymentNote || "Use this link to pay."}
              </p>
              <a href={data.paymentUrl} target="_blank" rel="noreferrer" className="mt-4 flex h-12 items-center justify-center rounded-2xl bg-white text-sm font-black text-black">
                Pay Now
              </a>
            </section>
          )}
          ...
          <a href={`sms:${smsPhone}?&body=${requestBody}`} className="flex items-center justify-between rounded-[1.5rem] bg-white px-5 py-5 text-base font-black text-black">
            Request Work
            <span>→</span>
          </a>
