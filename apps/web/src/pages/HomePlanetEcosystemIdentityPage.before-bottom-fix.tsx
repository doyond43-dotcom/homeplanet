    ...
    <main className="min-h-screen bg-[#0b0b08] text-stone-100">
      <section className="relative overflow-hidden px-6 py-20 sm:px-10 lg:px-16">
        ...
        <div className="relative mx-auto max-w-7xl">
          ...
          <section className="mt-20 rounded-[2rem] border border-stone-700/70 bg-stone-950/80 p-8 text-center">
            <p className="text-sm uppercase tracking-[0.35em] text-amber-300/70">
              Final Investor Reaction
            </p>
            <h2 className="mt-5 text-4xl font-semibold sm:text-5xl">
              “I can see this being built.”
            </h2>
            <p className="mx-auto mt-6 max-w-3xl text-lg leading-8 text-stone-300">
              That is the standard. Not futuristic. Not fake. Not overdesigned.
              Warm stone, wood accents, walkable paths, open-air gathering spaces,
              real services, and a coordination layer that makes daily life feel
              easier.
            </p>
          </section>
        </div>
