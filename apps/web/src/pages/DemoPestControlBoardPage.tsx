...
function buildMessage(type: string, request: PestRequest) {
  ...
  if (type === "photos") {
    return `Hey ${firstName}, this is The team with Lake Country Pest Control Pest Control. I got your request about ${service}. If you can, send me a quick photo or two of where you're seeing the activity around ${location}. That helps me know what I'm walking into before I come out.`;
  }

  if (type === "schedule") {
    return `Hey ${firstName}, this is The team with Lake Country Pest Control Pest Control. I reviewed your request about ${service} around ${location}. What day and time works best for me to come take a look?`;
  }

  if (type === "mosquito") {
    return `Hey ${firstName}, this is The team with Lake Country Pest Control Pest Control. For mosquito activity, I usually look at shaded areas, trees, bushes, fence lines, standing water areas, and places they hide during the day. I can help you get a plan together for that.`;
  }

  if (type === "payment") {
    return `Hey ${firstName}, this is The team with Lake Country Pest Control Pest Control. The service is ready for payment. I can send the payment option over now or collect on-site, whichever works best.`;
  }

  if (type === "review") {
    return `Hey ${firstName}, this is The team with Lake Country Pest Control Pest Control. Just checking back after the service. If everything looks good, a quick review on Google or Facebook would really help. I appreciate it.`;
  }

  return `Hey ${firstName}, this is The team with Lake Country Pest Control Pest Control. I got your request about ${service} around ${location}. I'm reviewing it now and wanted to follow up with you.`;
}

export default function DemoPestControlBoardPage() {
          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-3xl text-sm leading-7 text-white/64">
                Requests come in from the public page, then The team handles follow-up, scheduling,
                payment, proof, and review from one active workspace.
              </p>
            </div>

            <a
              href="/planet/demo/pest-control"
            ...
            <div className="grid gap-4 p-5 sm:p-7">
              ...
              <div className="grid gap-4 lg:grid-cols-2">
                ...
                <div className="rounded-3xl border border-[#1d79d6]/25 bg-black/45 p-5">
                  ...
                  <h3 className="mt-2 text-2xl font-black">The team’s notes</h3>
