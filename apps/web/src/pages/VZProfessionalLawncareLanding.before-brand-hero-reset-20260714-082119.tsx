        ...
        <div className="relative mx-auto flex min-h-[720px] max-w-[1380px] items-center px-5 py-20 sm:px-8 lg:px-10 lg:py-24">
          <div className="max-w-[980px]">
            ...
            <div className="mt-9 flex flex-col gap-3 sm:flex-row">
              <a
                href={`tel:${phone}`}
                className="inline-flex min-h-[58px] items-center justify-center gap-3 rounded-full bg-[#91e84d] px-7 text-sm font-black uppercase tracking-[0.12em] text-[#10140d] transition hover:bg-[#a8f56b]"
              >
                <Phone size={18} />
                Call Eric
              </a>
            ...
            <a
              href="#services"
              className="mt-5 inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-white/55 transition hover:text-[#91e84d]"
            >
              View services
