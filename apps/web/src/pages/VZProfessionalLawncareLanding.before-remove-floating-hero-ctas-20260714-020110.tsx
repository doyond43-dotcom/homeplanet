  ...
  return (
    <main className="min-h-screen bg-[#090b09] text-white">
      <section className="relative overflow-hidden border-b border-white/10">
        <div className="absolute right-5 top-5 z-30 flex items-center gap-2 sm:right-8 sm:top-7 lg:right-10">
          <a
            href={`sms:${phone}`}
            className="inline-flex min-h-11 items-center justify-center gap-2 rounded-full border border-white/15 bg-black/35 px-4 text-[10px] font-black uppercase tracking-[0.14em] text-white backdrop-blur-md transition hover:border-[#91e84d]/60 hover:text-[#91e84d]"
          >
          ...
          <a
            href={`tel:${phone}`}
            className="inline-flex min-h-11 items-center justify-center gap-2 rounded-full bg-[#91e84d] px-4 text-[10px] font-black uppercase tracking-[0.14em] text-[#10140d] shadow-lg shadow-black/20 transition hover:bg-[#a8f56b]"
          >
            <Phone size={15} />
