...
type BlockType = "whoWeAre" | "contactInfo" | "pricingNote" | "servicePills" | "livePhotoWall" | "localNote" | "bookNow";
...
const servicePills = useMemo(
  ...
  function launchLivePage() {
    ...
    localStorage.setItem(`hp:starter-live-page:${cleanSlug}`, JSON.stringify(pageData));
