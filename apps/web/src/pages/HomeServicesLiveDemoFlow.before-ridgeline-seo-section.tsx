    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="border-y border-white/10 bg-[#0b0b0d] px-4 py-14 text-center">
        <div className="mx-auto max-w-3xl">
          <h2 className="text-4xl font-black uppercase tracking-tight sm:text-5xl">
            A customer page that actually starts the job.
          </h2>
          <p className="mt-6 text-lg font-semibold leading-relaxed text-white/70">
            This page does more than show a phone number. It collects the service, address, photos, preference, and next move so the business can act without digging through scattered messages.
          </p>

          <a
            href="/planet/build-your-live-system"
            className="mt-8 inline-flex rounded-xl border border-orange-500/70 bg-orange-500/15 px-7 py-4 text-xs font-black uppercase tracking-[0.18em] text-orange-100 hover:bg-orange-500 hover:text-black"
          >
      ...
      <footer className="bg-black px-4 py-12 text-center">
        <div className="mx-auto max-w-3xl">
          <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full border border-orange-500/35 bg-orange-500/10 text-orange-300">
            <ShieldCheck size={26} />
          </div>
          ...
          <div className="mt-6 flex flex-col justify-center gap-3 sm:flex-row">
            <button
              type="button"
              onClick={() => openEstimate("House Wash")}
              className="rounded-xl bg-orange-500 px-6 py-3 text-xs font-black uppercase text-black hover:bg-orange-400"
            >
              Get Estimate
            </button>
            ...
            <a
              href="/planet/build-your-live-system"
              className="rounded-xl border border-white/15 bg-white/5 px-6 py-3 text-xs font-black uppercase text-white hover:bg-white/10"
            >
              Get something like this
            </a>
          </div>

          <p className="mt-8 text-[11px] font-semibold uppercase tracking-[0.18em] text-white/25">
