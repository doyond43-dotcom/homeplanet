...
export default function LakeExperienceBookingPage() {
          ...
          <aside className="space-y-6">
            <div className="rounded-[30px] border border-cyan-400/20 bg-cyan-400/10 p-6">
              ...
              <p className="mt-3 text-sm leading-7 text-white/70">
                {submitted
                  ? "The business would receive the request details so they can call, text, confirm availability, and turn the trip into a live memory experience."
