...
import SlapABugRequestPage from "./pages/SlapABugRequestPage";
import SlapABugBoardPage from "./pages/SlapABugBoardPage";
import SlapABugIntelligencePage from "./pages/SlapABugIntelligencePage";
function LiveShell() {
  return <Outlet />;
}
  ...
  return (
    <BrowserRouter>
      <Routes>
          ...
          <Route path="/planet/slap-a-bug/request" element={<SlapABugRequestPage />} />
          <Route path="/planet/slap-a-bug/board" element={<SlapABugBoardPage />} />
          <Route path="/planet/slap-a-bug/intelligence" element={<SlapABugIntelligencePage />} />
