...
<section
          style={{
            ...
            border: "1px solid rgba(255,255,255,0.08)",
            backgroundImage:
              "linear-gradient(90deg, rgba(2,5,4,0.90) 0%, rgba(2,5,4,0.76) 34%, rgba(2,5,4,0.34) 58%, rgba(2,5,4,0.02) 100%), linear-gradient(180deg, rgba(2,5,4,0.02), rgba(2,5,4,0.20)), url('/images/homeplanet-hero-connected-neighborhood.png')",
