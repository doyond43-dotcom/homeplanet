  ...
  const directions = [
    {
      ...
      detail: "Requests Â· Estimates Â· Scheduling Â· Payment Â· Proof",
      to: "/city/creator",
    },
    {
      number: "02",
      ...
      detail: "Family Â· Pet Care Â· Elder Care Â· Trusted Awareness",
      to: "/city/family",
    },
    {
      number: "03",
      ...
      detail: "Community Â· Events Â· Local Help Â· Opportunities",
            ...
            <article className="hp-story hp-story-business">
              ...
              <div className="hp-business-board">
                <div className="hp-business-signal">
                  ...
                  <strong>
                    â€œI need help getting my business under control.â€
                  </strong>
                </div>
            ...
            <article className="hp-story hp-story-community">
              ...
              <div className="hp-truth-board">
                ...
                <div className="hp-need-card">
                  ...
                  <strong>
                    â€œWe need volunteers for Saturdayâ€™s community cleanup.â€
                  </strong>
                </div>
            ...
            <article className="hp-story hp-story-lawn">
              ...
              <div className="hp-truth-board">
                ...
                <div className="hp-need-card">
                  ...
                  <strong>
                    â€œMy yard is overgrown and I need help covering the cost.â€
                  </strong>
                </div>
              ...
              <article className="hp-accountability-example">
                ...
                <div className="hp-accountability-ledger">
                  ...
                  <div>
                    ...
                    <strong>$20 assigned to one residentâ€™s lawn</strong>
                    <b>âˆ’$20</b>
                  </div>
                ...
                <div className="hp-accountability-example-truth">
                  People can see what the money accomplishedâ€”not only that
                  money changed hands.
                </div>
              </article>
