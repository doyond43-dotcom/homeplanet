...
<section
          style={{
            ...
            border: "1px solid rgba(255,255,255,0.08)",
            backgroundImage:
              "linear-gradient(90deg, rgba(2,5,4,0.99) 0%, rgba(2,5,4,0.94) 34%, rgba(2,5,4,0.62) 55%, rgba(2,5,4,0.08) 100%), linear-gradient(180deg, rgba(2,5,4,0.10), rgba(2,5,4,0.48)), url('/images/homeplanet-hero-connected-neighborhood.png')",
