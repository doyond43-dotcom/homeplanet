...
<section
          style={{
            ...hero,
            display: "grid",
            gridTemplateColumns: "minmax(0, 0.92fr) minmax(390px, 1.08fr)",
            gap: 54,
            alignItems: "center",
          }}
          className="hp-atlas-hero"
        >
          <div>
            <div style={eyebrow}>
              <span
          ...
          <div className="hp-homeplanet-hero-visual">
            <div className="hp-hero-orb hp-hero-orb-one" />
            <div className="hp-hero-orb hp-hero-orb-two" />

            <div className="hp-hero-visual-label">
              A HomePlanet system starts here
            </div>

            <div className="hp-hero-need">
              <div className="hp-hero-need-kicker">Real need</div>

              <div className="hp-hero-need-title">
                “I need help getting my business under control.”
              </div>

              <div className="hp-hero-need-copy">
                Start with what is actually happening. Then build the
                system around it.
              </div>
            </div>

            <div className="hp-hero-connector">
              <span />
              <strong>HomePlanet organizes what happens next</strong>
              <span />
            </div>

            <div className="hp-hero-workspace">
              <div className="hp-hero-workspace-top">
                <div>
                  <div className="hp-hero-workspace-kicker">
                    Active workspace
                  </div>

                  <div className="hp-hero-workspace-title">
                    Everything now has a place.
                  </div>
                </div>

                <div className="hp-hero-live-pill">Live</div>
              </div>

              <div className="hp-hero-next">
        ...
        <section className="hp-real-world-section">
            ...
            <article className="hp-story hp-story-community">
              <div className="hp-story-copy">
                ...
                <div className="hp-story-label">
                  Community program + truth chain
                </div>

                <h3>
                  Okeechobee Together organizes the need. The Lawn Program
                  moves the work.
                </h3>

                <p>
                  A resident needs help. Okeechobee Together reviews the need,
                  connects a local worker or slow local business, approves
                  Piggy Bank support, tracks the money, and keeps the proof
                  attached from beginning to end.
                </p>

                <div className="hp-story-point">
                  The organizer, worker, resident, sponsor, and community can
                  all understand what happened without digging through texts,
                  spreadsheets, receipts, and separate apps.
                </div>
              </div>
              ...
              <div className="hp-truth-board">
                <div className="hp-board-head">
                  <div>
                    ...
                    <strong>Lawn Program truth chain</strong>
                  </div>
            ...
            <article className="hp-story hp-story-sale">
              ...
              <div className="hp-sale-board">
                <div className="hp-sale-image">
                  <div className="hp-sale-image-glow" />

                  <div className="hp-sale-price">$35</div>

                  <div className="hp-sale-object">
                    <div className="hp-sale-object-top" />
                    <div className="hp-sale-object-body" />
                  </div>
        ...
        <section className="hp-homeplanet-point">
          <div className="hp-homeplanet-point-inner">
            ...
            <p>
              One living truth chain can serve a business, a community
              program, a yard sale, a family, a project, or something that has
      ...
      <style>{`
        ...
        .hp-point-action {
          ...
          box-shadow: 0 16px 38px rgba(48, 255, 115, 0.16);
        }
