...
function CityIndex() {
  ...
  const cityTo = (c: string) => {
    ...
    if (c === "safety") return "/planet/guardian-panic";
    if (c === "family") return "/planet/guardian-pet";
    if (c === "commerce") return "/planet/demo/lake-showcase";
    return `/city/${c}`;
  };
...
export default function CityRoutes() {
  return (
    <Routes>
      ...
      <Route path="safety" element={<Navigate to="/planet/guardian-panic" replace />} />
      <Route path="family" element={<Navigate to="/planet/guardian-pet" replace />} />
      <Route path="commerce" element={<Navigate to="/planet/demo/lake-showcase" replace />} />
