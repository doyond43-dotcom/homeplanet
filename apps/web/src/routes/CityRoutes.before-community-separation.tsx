          ...
          >
            ...
            <div
              style={{
                maxWidth: 1020,
                marginTop: 32,
                fontSize: "clamp(35px, 5.6vw, 73px)",
                lineHeight: 0.97,
                letterSpacing: "-0.065em",
                fontWeight: 900,
                color: "#59ff91",
                textShadow: "0 0 42px rgba(65,255,126,0.14)",
              }}
            >
              See the need. Follow the action. Prove the outcome.
            </div>
            ...
            >
              HomePlanet connects people, work, money, decisions,
              communication, and proof from the first signal to the final
              result.
            </p>
            ...
            <p
              style={{
                maxWidth: 760,
                margin: "18px 0 0",
                color: "rgba(228,243,233,0.45)",
                fontSize: 16,
                lineHeight: 1.6,
              }}
            >
              A business request, community program, yard sale, payment,
              receipt, worker, before photo, and completed outcome can remain
              part of one understandable history.
            </p>
