...
<section
        ...
        >
          ...
          >
            ...
            >
              Start with what you're trying to move forward.
            </h2>
          </div>
              ...
              <div className="hp-sale-board">
                <div className="hp-sale-image">
                  <img
                    ...
                    src="/images/homeplanet-live-yard-sale.png"
                    alt="Solid wood side table being shown during a live neighborhood yard sale"
                  />
      ...
      <style>{`
        ...
        .hp-sale-real-image {
          ...
          object-position: 56% 70% !important;
          position: absolute;
          inset: 0;
          width: 100%;
          height: 100%;
