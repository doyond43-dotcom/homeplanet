  ...
  },
  {
    ...
    body: `
      ...
      <section>
        ...
        <p>The rental experience is being built around the real JME inventory and operating process. Customers will be able to start with the equipment they need, request rental dates, provide project details, and identify whether pickup or delivery is needed.</p>
      ...
      <section>
        ...
        <p>Customers can begin a repair request by identifying the equipment, describing the problem, providing model or serial information when available, and sharing photos that help JME review the machine.</p>
