...
function petSummaryLine(pet: PetProfile) {
  ...
  return parts.length ? parts.join(" Â· ") : "Profile not entered yet";
}
  ...
  async function placeOrder() {
    ...
    try {
      ...
      setPaymentMemo(
        ...
        `${nextOrderId} Â· ${buildPetAwareMemo(
          ...
          {orderPlaced && !paymentMarked && paymentDrawerOpen ? (
            ...
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <h2 id="pet-tag-payment-title" className="mt-2 pr-12 text-3xl font-bold tracking-[-0.035em] text-white">Complete your payment</h2>
              </div>
            ...
            <div className="mt-4 rounded-2xl border border-emerald-500/20 bg-emerald-500/10 p-4">
              <div>
                ...
                <p className="mt-1 text-sm text-neutral-200">
                  {pricing.petCount} pet{petCount > 1 ? "s" : ""} Â· Setup {currency(pricing.setupTotal)}
                </p>
