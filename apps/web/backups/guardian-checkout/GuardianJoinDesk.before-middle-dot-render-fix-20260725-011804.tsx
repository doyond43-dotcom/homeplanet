...
function petSummaryLine(pet: PetProfile) {
  ...
  return parts.length ? parts.join(" &middot; ") : "Profile not entered yet";
}
  ...
  async function placeOrder() {
    ...
    try {
      ...
      setPaymentMemo(
        ...
        `${nextOrderId} &middot; ${buildPetAwareMemo(
            ...
            <div className="mt-4 rounded-2xl border border-emerald-500/20 bg-emerald-500/10 p-4">
              <div>
                ...
                <p className="mt-1 text-sm text-neutral-200">
                  {pricing.petCount} pet{petCount > 1 ? "s" : ""} &middot; Setup {currency(pricing.setupTotal)}
                </p>
