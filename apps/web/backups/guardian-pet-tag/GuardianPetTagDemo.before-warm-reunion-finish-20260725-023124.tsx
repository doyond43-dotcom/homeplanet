          ...
          <div className="grid gap-8 sm:grid-cols-[1fr_auto] sm:items-end">
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="relative inline-flex items-center rounded-full border border-cyan-300/25 bg-cyan-300/[0.06] py-2.5 pl-6 pr-5 text-sm font-bold uppercase tracking-[0.18em] text-cyan-200">
                  <span className="absolute left-3 h-1.5 w-1.5 rounded-full border border-cyan-200/55" />
                  Pet Tag
                </span>
              </div>
    ...
    <div className="mx-auto max-w-3xl space-y-4 pb-8">
      ...
      <header className="flex min-h-[52px] items-center border-b border-white/[0.07] px-1 pb-3">
        {isLandingDemo ? (
          ...
          <div className="relative inline-flex items-center rounded-full border border-cyan-300/25 bg-cyan-300/[0.06] py-2.5 pl-6 pr-5 text-sm font-bold uppercase tracking-[0.18em] text-cyan-200">
            <span className="absolute left-3 h-1.5 w-1.5 rounded-full border border-cyan-200/55" />
            Pet Tag
          </div>
        )}
      ...
      >
        ...
        <p className="mt-3 text-sm leading-7 text-white/70 sm:text-base">
          {isMissing
            ? `${pet.name}'s family is looking for her. Call or text them directly below.`
